...
`, "%p": q => 0 <= q.Hb && 12 > q.Hb ? "AM" : "PM", "%S": q => B(q.kc, 2), "%t": () => "	", "%u": q => q.ub || 7, "%U": q => B(Math.floor((q.Bb + 7 - q.ub) / 7), 2), "%V": q => { var De = Math.floor((q.Bb + 7 - (q.ub + 6) % 7) / 7); if (2 >= (q.ub + 371 - q.Bb - 2) % 7 && De++, De) De == 53 && ((tt = (q.ub + 371 - q.Bb) % 7) == 4 || tt == 3 && kr(q.Cb) || (De = 1)); else { De = 52; var tt = (q.ub + 7 - q.Bb - 1) % 7; (tt == 4 || tt == 5 && kr(q.Cb % 400 - 1)) && De++ } return B(De, 2) }, "%w": q => q.ub, "%W": q => B(Math.floor((q.Bb + 7 - (q.ub + 6) % 7) / 7), 2), "%y": q => (q.Cb + 1900).toString().substring(2), "%Y": q => q.Cb + 1900, "%z": q => { var De = 0 <= (q = q.ic); return q = Math.abs(q) / 60, (De ? "+" : "-") + ("0000" + (q / 60 * 100 + q % 60)).slice(-4) }, "%Z": q => q.lc, "%%": () => "%"
  ...
  fn i2o_${e}(indices: ${f.indices}) -> u32 {
    return ${M.join("+")};
  }`, U = z => (x.indicesToOffset = !0, u < 2 ? z : `i2o_${e}(${z})`), Y = (...z) => u === 0 ? "0u" : `${f.indices}(${z.map(b).join(",")})`, ae = (z, N) => u < 2 ? `${z}` : `${ge(z, N, u)}`, oe = (z, N, re) => u < 2 ? `${z}=${re};` : `${ge(z, N, u)}=${re};`, $e = {}, xe = (z, N) => {
        x.broadcastedIndicesToOffset = !0; let re = `${N.name}broadcastedIndicesTo${e}Offset`; if (re in $e) return `${re}(${z})`; let ce = []; for (let ve = u - 1; ve >= 0; ve--) { let Ce = N.indicesGet("outputIndices", ve + N.rank - u); ce.push(`${ae(A, ve)} * (${Ce} % ${ae(T, ve)})`) } return $e[re] = `fn ${re}(outputIndices: ${N.type.indices}) -> u32 {
             return ${ce.length > 0 ? ce.join("+") : "0u"};
           }`, `${re}(${z})`
      }, de = (z, N) => (() => { if (f.storage === f.value) return `${e}[${z}]=${N};`; if (f.storage === "vec2<u32>" && f.value === "i32") return `${e}[${z}]=vec2<u32>(u32(${N}), select(0u, 0xFFFFFFFFu, ${N} < 0));`; if (f.storage === "vec2<u32>" && f.value === "u32") return `${e}[${z}]=vec2<u32>(u32(${N}), 0u);`; if (f.storage === "u32" && f.value === "vec4<bool>") return `${e}[${z}]=dot(vec4<u32>(0x1, 0x100, 0x10000, 0x1000000), vec4<u32>(${N}));`; throw new Error(`not supported combination of storage type ${f.storage} and value type ${f.value} yet`) })(), Re = z => (() => { if (f.storage === f.value) return `${e}[${z}]`; if (f.storage === "vec2<u32>" && f.value === "i32") return `i32(${e}[${z}].x)`; if (f.storage === "vec2<u32>" && f.value === "u32") return `u32(${e}[${z}].x)`; if (f.storage === "u32" && f.value === "vec4<bool>") return `vec4<bool>(bool(${e}[${z}] & 0xFFu), bool(${e}[${z}] & 0xFF00u), bool(${e}[${z}] & 0xFF0000u), bool(${e}[${z}] & 0xFF000000u))`; throw new Error(`not supported combination of storage type ${f.storage} and value type ${f.value} yet`) })(), Be = u < 2 ? "" : `
  fn get_${e}ByIndices(indices: ${f.indices}) -> ${_} {
    return ${Re(`i2o_${e}(indices)`)};
  }`, be = u < 2 ? "" : (() => {
        let z = h.map(re => `d${re}: u32`).join(", "), N = h.map(re => `d${re}`).join(", "); return `
  fn get_${e}(${z}) -> ${_} {
...
`)
      ...
      if (this.uniforms.length === 0) return ""; let e = []; for (let { name: r, type: i, length: s } of this.uniforms) if (s && s > 4) i === "f16" ? e.push(`@align(16) ${r}:array<mat2x4<${i}>, ${Math.ceil(s / 8)}>`) : e.push(`${r}:array<vec4<${i}>, ${Math.ceil(s / 4)}>`); else { let o = s == null || s === 1 ? i : `vec${s}<${i}>`; e.push(`${r}:${o}`) } return `
...
`)
  ...
  }, w0 = (e, r) => new Lh(e, r), Zs = (e, r) => { let i = e.length, s = []; for (let o = 0; o < i; o++) { let d = i - 1 - o, u = e[d] || 1; (r[r.length - 1 - o] || 1) > 1 && u === 1 && s.unshift(d) } return s }
}), Uh, Jd, jh, Fh, Wh, un, v0, _0, Qr = ne(() => {
  Ae(), Pe(), gt(), Me(), Uh = e => { if (!e || e.length !== 1) throw new Error("Transpose requires 1 input.") }, Jd = (e, r) => r && r.length !== e ? [...new Array(e).keys()].reverse() : r, jh = (e, r) => Q.sortBasedOnPerm(e, Jd(e.length, r)), Fh = (e, r, i, s) => {
    let o = `fn perm(i: ${s.type.indices}) -> ${i.type.indices} {
    var a: ${i.type.indices};`; for (let d = 0; d < r; ++d)o += i.indicesSet("a", e[d], `i[${d}]`); return o += "return a;}"
  }, Wh = (e, r) => { let i = [], s = []; for (let o = 0; o < e.length; ++o)e[o] !== 1 && i.push(e[o]), e[r[o]] !== 1 && s.push(r[o]); return { newShape: i, newPerm: s } }, un = (e, r) => {
    let i = e.dataType, s = e.dims.length, o = Jd(s, r), d = jh(e.dims, o), { newShape: u, newPerm: h } = Wh(e.dims, o), m = Q.areEqual(h, [2, 3, 1]), g = Q.areEqual(h, [3, 1, 2]), _ = u.length === 2 && h[0] > h[1] || m || g, v = _ ? u : e.dims, f = d; _ && (v = m ? [u[0], u[1] * u[2]] : g ? [u[0] * u[1], u[2]] : u, f = [v[1], v[0]]); let b = X("a", i, v.length), x = _e("output", i, f.length), S = 16, T; return _ ? T = A => `
  ...
  }`, { name: _ ? "TransposeShared" : "Transpose", shaderCache: { hint: `${r}`, inputDependencies: ["rank"] }, getRunData: () => { let A = Q.size(d); return { outputs: [{ dims: d, dataType: e.dataType }], dispatchGroup: _ ? { x: Math.ceil(f[1] / S), y: Math.ceil(f[0] / S) } : { x: Math.ceil(A / 64) }, programUniforms: [{ type: 12, data: A }, ...he(v, f)] } }, getShaderSource: T }
  }, v0 = (e, r) => { Uh(e.inputs), e.compute(un(e.inputs[0], r.perm)) }, _0 = e => Ze({ perm: e.perm })
}), Vh, Hh, qh, Gh, Kh, Qh, Yh, Zh, Xh, Jh, zn, $0, x0, b0, S0, k0, E0, C0, T0, I0, z0, j_ = ne(() => {
  Ae(), Pe(), Me(), lf(), Qr(), Vh = { max: "select(bestValue, candidate, candidate > bestValue)", min: "select(bestValue, candidate, candidate < bestValue)", mean: "bestValue + candidate", sum: "bestValue + candidate", prod: "bestValue * candidate", sumSquare: "bestValue + candidate * candidate", logSumExp: "bestValue + exp(candidate)", l1: "bestValue + abs(candidate)", l2: "bestValue + candidate * candidate", logSum: "bestValue + candidate" }, Hh = { max: "select(bestValue, candidate, candidate > bestValue)", min: "select(bestValue, candidate, candidate < bestValue)", mean: "bestValue + candidate", sum: "bestValue + candidate", prod: "bestValue * candidate", sumSquare: "bestValue + candidate", logSumExp: "bestValue + candidate", l1: "bestValue + candidate", l2: "bestValue + candidate", logSum: "bestValue + candidate" }, qh = { max: "_A[offset]", min: "_A[offset]", mean: "0", sum: "0", prod: "1", sumSquare: "0", logSumExp: "0", l1: "0", l2: "0", logSum: "0" }, Gh = { max: "bestValue", min: "bestValue", sum: "bestValue", prod: "bestValue", sumSquare: "bestValue", logSumExp: "log(bestValue)", l1: "bestValue", l2: "sqrt(bestValue)", logSum: "log(bestValue)" }, Kh = (e, r) => { let i = []; for (let s = r - e; s < r; ++s)i.push(s); return i }, Qh = (e, r) => { let i = [], s = e.length; for (let d = 0; d < s; d++)r.indexOf(d) === -1 && i.push(e[d]); let o = r.map(d => e[d]); return [i, o] }, Yh = (e, r) => { let i = e.length + r.length, s = [], o = 0; for (let d = 0; d < i; d++)r.indexOf(d) === -1 ? s.push(e[o++]) : s.push(1); return s }, Zh = (e, r) => { for (let i = 0; i < e.length; ++i)if (e[e.length - i - 1] !== r - 1 - i) return !1; return !0 }, Xh = (e, r) => { let i = []; if (!Zh(e, r)) { for (let s = 0; s < r; ++s)e.indexOf(s) === -1 && i.push(s); e.forEach(s => i.push(s)) } return i }, Jh = (e, r, i, s, o, d, u) => {
    let h = i[0].dims, m = Q.size(d), g = Q.size(u), _ = X("_A", i[0].dataType, h), v = _e("output", o, d), f = 32, b = `
          var<workgroup> aBestValues : array<f32, ${f}>;
       `; return {
      name: e, shaderCache: r, getShaderSource: x => `
        ...
        }`, getRunData: () => ({ outputs: [{ dims: d, dataType: o }], dispatchGroup: { x: m }, programUniforms: [{ type: 12, data: g }] })
    }
  }, zn = (e, r, i, s) => { let o = e.inputs.length === 1 ? i : Pc(e.inputs, i), d = o.axes; d.length === 0 && !o.noopWithEmptyAxes && (d = e.inputs[0].dims.map((b, x) => x)); let u = Q.normalizeAxes(d, e.inputs[0].dims.length), h = u, m = e.inputs[0], g = Xh(h, e.inputs[0].dims.length); g.length > 0 && (m = e.compute(un(e.inputs[0], g), { inputs: [0], outputs: [-1] })[0], h = Kh(h.length, m.dims.length)); let [_, v] = Qh(m.dims, h), f = _; o.keepDims && (f = Yh(_, u)), e.compute(Jh(r, { hint: o.cacheKey, inputDependencies: ["type"] }, [m], s, e.inputs[0].dataType, f, v), { inputs: [m] }) }, $0 = (e, r) => { zn(e, "ReduceMeanShared", r, "mean") }, x0 = (e, r) => { zn(e, "ReduceL1Shared", r, "l1") }, b0 = (e, r) => { zn(e, "ReduceL2Shared", r, "l2") }, S0 = (e, r) => { zn(e, "ReduceLogSumExpShared", r, "logSumExp") }, k0 = (e, r) => { zn(e, "ReduceMaxShared", r, "max") }, E0 = (e, r) => { zn(e, "ReduceMinShared", r, "min") }, C0 = (e, r) => { zn(e, "ReduceProdShared", r, "prod") }, T0 = (e, r) => { zn(e, "ReduceSumShared", r, "sum") }, I0 = (e, r) => { zn(e, "ReduceSumSquareShared", r, "sumSquare") }, z0 = (e, r) => { zn(e, "ReduceLogSumShared", r, "logSum") }
}), An, em, Xu, Pc, Rn, tm, nm, rm, im, am, sm, om, um, lm, dm, On, A0, R0, O0, P0, M0, B0, D0, N0, L0, U0, lf = ne(() => {
  Ae(), Pe(), gt(), Me(), j_(), An = e => { if (!e || e.length === 0 || e.length > 2) throw new Error("Reduce op requires 1 or 2 inputs."); if (e.length === 2 && e[1].dims.length !== 1) throw new Error("Invalid axes input dims.") }, em = e => ["", "", `var value = ${e.getByIndices("input_indices")};`, ""], Xu = (e, r, i, s, o, d, u = !1, h = !1) => {
    let m = [], g = i[0].dims, _ = g.length, v = Q.normalizeAxes(o, _), f = !h && v.length === 0; g.forEach((S, T) => { f || v.indexOf(T) >= 0 ? u && m.push(1) : m.push(S) }); let b = m.length, x = Q.size(m); return {
      name: e, shaderCache: r, getShaderSource: S => {
        let T = [], A = X("_A", i[0].dataType, _), C = _e("output", d, b), O = s(A, C, v), R = O[2]; for (let M = 0, W = 0; M < _; M++)f || v.indexOf(M) >= 0 ? (u && W++, R = `for(var j${M}: u32 = 0; j${M} < ${g[M]}; j${M}++) {
...
`)}
        }`}, getRunData: () => ({ outputs: [{ dims: m, dataType: d }], dispatchGroup: { x: Math.ceil(x / 64) }, programUniforms: [{ type: 12, data: x }, ...he(g, m)] })
    }
  }, Pc = (e, r) => { let i = []; return e[1].dims[0] > 0 && e[1].getBigInt64Array().forEach(s => i.push(Number(s))), Ze({ axes: i, keepDims: r.keepDims, noopWithEmptyAxes: r.noopWithEmptyAxes }) }, Rn = (e, r, i, s) => { let o = e.inputs, d = o.length === 1 ? i : Pc(o, i); e.compute(Xu(r, { hint: d.cacheKey, inputDependencies: ["rank"] }, [o[0]], d.noopWithEmptyAxes && d.axes.length === 0 ? em : s, d.axes, o[0].dataType, d.keepDims, d.noopWithEmptyAxes), { inputs: [0] }) }, tm = (e, r) => { An(e.inputs), Rn(e, "ReduceLogSum", r, (i, s) => [`var value = ${s.type.storage}(0);`, "", `value += ${i.getByIndices("input_indices")};`, "value = log(value);"]) }, nm = (e, r) => { An(e.inputs), Rn(e, "ReduceL1", r, (i, s) => [`var value = ${s.type.storage}(0);`, "", `value += abs(${i.getByIndices("input_indices")});`, ""]) }, rm = (e, r) => { An(e.inputs), Rn(e, "ReduceL2", r, (i, s) => [`var t = ${s.type.value}(0); var value = ${s.type.value}(0);`, "", `t = ${i.getByIndices("input_indices")}; value += (t * t);`, "value = sqrt(value);"]) }, im = (e, r) => { An(e.inputs), Rn(e, "ReduceLogSumExp", r, (i, s) => [`var value = ${s.type.storage}(0);`, "", `value += exp(${i.getByIndices("input_indices")});`, "value = log(value);"]) }, am = (e, r) => {
    An(e.inputs), Rn(e, "ReduceMax", r, (i, s, o) => {
      let d = []; for (let u = 0; u < i.rank; u++)(o.indexOf(u) >= 0 || o.length === 0) && d.push(i.indicesSet("input_indices", u, 0)); return [`${d.join(`
`)}`, `var value = ${i.getByIndices("input_indices")};`, `value = max(value, ${i.getByIndices("input_indices")});`, ""]
    })
  }, sm = (e, r) => { An(e.inputs), Rn(e, "ReduceMean", r, (i, s, o) => { let d = 1; for (let u = 0; u < i.rank; u++)(o.indexOf(u) >= 0 || o.length === 0) && (d *= e.inputs[0].dims[u]); return ["var sum = f32(0);", "", `sum += f32(${i.getByIndices("input_indices")});`, `let value = ${s.type.value}(sum / ${d});`] }) }, om = (e, r) => {
    An(e.inputs), Rn(e, "ReduceMin", r, (i, s, o) => {
      let d = []; for (let u = 0; u < i.rank; u++)(o.indexOf(u) >= 0 || o.length === 0) && d.push(`input_indices[${u}] = 0;`); return [`${d.join(`
`)}`, `var value = ${i.getByIndices("input_indices")};`, `value = min(value, ${i.getByIndices("input_indices")});`, ""]
    })
  }, um = (e, r) => { An(e.inputs), Rn(e, "ReduceProd", r, (i, s) => [`var value = ${s.type.storage}(1);`, "", `value *= ${i.getByIndices("input_indices")};`, ""]) }, lm = (e, r) => { An(e.inputs), Rn(e, "ReduceSum", r, (i, s) => [`var value = ${s.type.storage}(0);`, "", `value += ${i.getByIndices("input_indices")};`, ""]) }, dm = (e, r) => { An(e.inputs), Rn(e, "ReduceSumSquare", r, (i, s) => [`var t = ${s.type.value}(0); var value = ${s.type.value}(0);`, "", `t = ${i.getByIndices("input_indices")}; value += t * t;`, ""]) }, On = (e, r, i) => { if (r.length === 0) return i; let s = 1, o = 1; for (let d = 0; d < r.length; d++)r.indexOf(d) === -1 ? s *= e[d] : o *= e[d]; return o < 32 && s > 1024 }, A0 = (e, r) => { On(e.inputs[0].dims, r.axes, r.noopWithEmptyAxes) ? sm(e, r) : $0(e, r) }, R0 = (e, r) => { On(e.inputs[0].dims, r.axes, r.noopWithEmptyAxes) ? nm(e, r) : x0(e, r) }, O0 = (e, r) => { On(e.inputs[0].dims, r.axes, r.noopWithEmptyAxes) ? rm(e, r) : b0(e, r) }, P0 = (e, r) => { On(e.inputs[0].dims, r.axes, r.noopWithEmptyAxes) ? im(e, r) : S0(e, r) }, M0 = (e, r) => { On(e.inputs[0].dims, r.axes, r.noopWithEmptyAxes) ? am(e, r) : k0(e, r) }, B0 = (e, r) => { On(e.inputs[0].dims, r.axes, r.noopWithEmptyAxes) ? om(e, r) : E0(e, r) }, D0 = (e, r) => { On(e.inputs[0].dims, r.axes, r.noopWithEmptyAxes) ? um(e, r) : C0(e, r) }, N0 = (e, r) => { On(e.inputs[0].dims, r.axes, r.noopWithEmptyAxes) ? lm(e, r) : T0(e, r) }, L0 = (e, r) => { On(e.inputs[0].dims, r.axes, r.noopWithEmptyAxes) ? dm(e, r) : I0(e, r) }, U0 = (e, r) => { On(e.inputs[0].dims, r.axes, r.noopWithEmptyAxes) ? tm(e, r) : z0(e, r) }
}), ec, j0, F0, Mc, F_ = ne(() => {
  Ae(), gt(), lf(), ec = e => { if (!e || e.length === 0 || e.length > 2) throw new Error("ArgMinMaxOp op requires 1 or 2 inputs."); if (e[0].dataType !== 1) throw new Error("Invalid input type.") }, j0 = (e, r) => {
    ec(e.inputs); let i = (s, o, d) => {
...
var best_index : i32 = 0;`, `if (${s.getByIndices("input_indices")} ${r.selectLastIndex > 0 ? "<=" : "<"} value) {
    ...
    }; e.compute(Xu("ArgMin", { hint: r.cacheKey, inputDependencies: ["rank"] }, [e.inputs[0]], i, [r.axis], 7, r.keepDims), { inputs: [0] })
  }, F0 = (e, r) => {
    ec(e.inputs); let i = (s, o, d) => {
      let u = []; for (let h = 0; h < s.rank; h++)(d.indexOf(h) >= 0 || d.length === 0) && u.push(`input_indices[${h}] = 0;`); return [`${u.join(`
`)}`, `var value = ${s.getByIndices("input_indices")};
var best_index : i32 = 0;`, `if (${s.getByIndices("input_indices")} ${r.selectLastIndex > 0 ? ">=" : ">"} value) {
  ...
  }`}; return { name: "AttentionProbs", shaderCache: { hint: `${b};${o !== void 0};${s !== void 0};${e}`, inputDependencies: O }, getRunData: () => ({ outputs: R, dispatchGroup: T, programUniforms: A }), getShaderSource: M }
  }, hm = (e, r, i, s, o, d) => {
    let u = d + o.kvSequenceLength, h = o.nReps ? o.nReps : 1, m = o.vHiddenSize * h, g = o.kvNumHeads == null && e > 1 && s, _ = g ? [o.batchSize, o.numHeads, u, o.headSize] : void 0, v = [o.batchSize, o.sequenceLength, m], f = 12, b = { x: Math.ceil(o.vHeadSize / f), y: Math.ceil(o.sequenceLength / f), z: o.batchSize * o.numHeads }, x = [{ type: 12, data: o.sequenceLength }, { type: 12, data: u }, { type: 12, data: o.vHeadSize }, { type: 12, data: o.numHeads }, { type: 12, data: m }, { type: 12, data: d }, { type: 12, data: o.kvSequenceLength }], S = g && s && Q.size(s.dims) > 0, T = ["type", "type"]; S && T.push("type"); let A = [{ dims: v, dataType: r.dataType, gpuDataType: 0 }]; g && A.push({ dims: _, dataType: r.dataType, gpuDataType: 0 }); let C = O => {
      let R = X("probs", r.dataType, r.dims), M = X("v", i.dataType, i.dims), W = [R, M]; S && W.push(X("past_value", s.dataType, s.dims)); let U = [_e("output", r.dataType, v)]; g && U.push(_e("present_value", r.dataType, _)); let Y = [{ name: "M", type: "u32" }, { name: "K", type: "u32" }, { name: "N", type: "u32" }, { name: "num_heads", type: "u32" }, { name: "v_hidden_size", type: "u32" }, { name: "past_sequence_length", type: "u32" }, { name: "kv_sequence_length", type: "u32" }]; return `
  const TILE_SIZE = ${f}u;
  ...
  }`}; return { name: "AttentionScore", shaderCache: { hint: `${s !== void 0};${e}`, inputDependencies: T }, getRunData: () => ({ outputs: A, dispatchGroup: b, programUniforms: x }), getShaderSource: C }
  }, Xs = (e, r, i, s, o, d, u, h, m, g, _) => { let v = Math.min(e.outputCount, 1 + (u ? 1 : 0) + (h ? 1 : 0)), f = g.kvNumHeads !== void 0 || v > 1 ? g.pastSequenceLength : 0, b = f + g.kvSequenceLength, x = m && Q.size(m.dims) > 0 ? m : void 0, S = [r, i]; g.kvNumHeads === void 0 && v > 1 && u && Q.size(u.dims) > 0 && S.push(u), x && S.push(x); let T = e.compute(pm(v, r, i, u, x, g, _, f), { inputs: S, outputs: g.kvNumHeads === void 0 && v > 1 ? [-1, 1] : [-1] })[0]; e.compute(fm(T, g.batchSize * g.numHeads * g.sequenceLength, b), { inputs: [T], outputs: [] }); let A = [T, s]; g.kvNumHeads === void 0 && v > 1 && h && Q.size(h.dims) > 0 && A.push(h), e.compute(hm(v, T, s, h, g, f), { inputs: A, outputs: g.kvNumHeads === void 0 && v > 1 ? [0, 2] : [0] }) }, mm = (e, r) => {
    let i = [r.batchSize, r.numHeads, r.sequenceLength, r.headSize], s = r.sequenceLength, o = r.inputHiddenSize, d = r.headSize, u = 12, h = { x: Math.ceil(r.headSize / u), y: Math.ceil(r.sequenceLength / u), z: r.batchSize * r.numHeads }, m = [e.inputs[0], e.inputs[1], e.inputs[2]], g = [{ type: 12, data: s }, { type: 12, data: o }, { type: 12, data: d }, { type: 12, data: r.numHeads }, { type: 12, data: r.headSize }, { type: 12, data: r.hiddenSize }, { type: 12, data: r.hiddenSize + r.hiddenSize + r.vHiddenSize }], _ = v => {
      let f = _e("output_q", m[0].dataType, i), b = _e("output_k", m[0].dataType, i), x = _e("output_v", m[0].dataType, i), S = X("input", m[0].dataType, m[0].dims), T = X("weight", m[1].dataType, m[1].dims), A = X("bias", m[2].dataType, m[2].dims), C = S.type.storage, O = [{ name: "M", type: "u32" }, { name: "K", type: "u32" }, { name: "N", type: "u32" }, { name: "num_heads", type: "u32" }, { name: "head_size", type: "u32" }, { name: "hidden_size", type: "u32" }, { name: "ldb", type: "u32" }]; return `
  const TILE_SIZE = ${u}u;
  ...
  }`}; return e.compute({ name: "AttentionPrepare", shaderCache: { inputDependencies: ["type", "type", "type"] }, getRunData: () => ({ outputs: [{ dims: i, dataType: e.inputs[0].dataType, gpuDataType: 0 }, { dims: i, dataType: e.inputs[0].dataType, gpuDataType: 0 }, { dims: i, dataType: e.inputs[0].dataType, gpuDataType: 0 }], dispatchGroup: h, programUniforms: g }), getShaderSource: _ }, { inputs: m, outputs: [-1, -1, -1] })
  }, W0 = (e, r) => { let i = cm(e.inputs, r), [s, o, d] = mm(e, i); return Xs(e, s, o, d, e.inputs[4], void 0, void 0, void 0, e.inputs[5], i, r) }
}), gm, ym, wm, V0, W_ = ne(() => {
  Bn(), Ae(), Pe(), gt(), Me(), gm = (e, r) => { if (!e || e.length !== 5) throw new Error("BatchNormalization requires 5 inputs"); let i = (s, o, d) => { let u = o.length; if (u !== s.length) throw new Error(`${d}: num dimensions != ${u}`); o.forEach((h, m) => { if (h !== s[m]) throw new Error(`${d}: dim[${m}] do not match`) }) }; if (e[0].dims.length > 1) { let s = r.format === "NHWC" ? r.spatial ? e[0].dims.slice(-1) : e[0].dims.slice(-1).concat(e[0].dims.slice(1, e[0].dims.length - 1)) : e[0].dims.slice(1, r.spatial ? 2 : void 0); i(e[1].dims, s, "Invalid input scale"), i(e[2].dims, s, "Invalid input B"), i(e[3].dims, s, "Invalid input mean"), i(e[4].dims, s, "Invalid input var") } else i(e[1].dims, [1], "Invalid input scale"), i(e[2].dims, [1], "Invalid input B"), i(e[3].dims, [1], "Invalid input mean"), i(e[4].dims, [1], "Invalid input var") }, ym = (e, r) => {
    let { epsilon: i, spatial: s, format: o } = r, d = e[0].dims, u = s ? pt(d[d.length - 1]) : 1, h = o === "NHWC" && d.length > 1 ? u : 1, m = Q.size(d) / u, g = s, _ = g ? d.length : d, v = X("x", e[0].dataType, e[0].dims, u), f = X("scale", e[1].dataType, e[1].dims, h), b = X("bias", e[2].dataType, e[2].dims, h), x = X("inputMean", e[3].dataType, e[3].dims, h), S = X("inputVar", e[4].dataType, e[4].dims, h), T = _e("y", e[0].dataType, _, u), A = () => {
      let O = ""; if (s) O = `let cOffset = ${d.length === 1 ? "0u" : o === "NHWC" ? `outputIndices[${d.length - 1}] / ${u}` : "outputIndices[1]"};`; else if (o === "NCHW") O = `
            ${T.indicesSet("outputIndices", "0", "0")}
            let cOffset = ${T.indicesToOffset("outputIndices")};`; else {
        O = `var cIndices = ${f.type.indices}(0);
                       cIndices[0] = outputIndices[${d.length - 1}];`; for (let R = 1; R < f.rank; R++)O += `cIndices[${R}] = outputIndices[${R}];`; O += `let cOffset = ${f.indicesToOffset("cIndices")};`
      } return O
    }, C = O => `
  const epsilon = ${i};
  ...
  }`; return { name: "BatchNormalization", shaderCache: { hint: `${r.epsilon}_${r.format}_${s}_${u}`, inputDependencies: g ? ["rank", "type", "type", "type", "type"] : void 0 }, getShaderSource: C, getRunData: () => ({ outputs: [{ dims: e[0].dims, dataType: e[0].dataType }], dispatchGroup: { x: Math.ceil(m / 64) }, programUniforms: g ? [{ type: 12, data: m }, ...he(d)] : [{ type: 12, data: m }] }) }
  }, wm = e => Ze(e), V0 = (e, r) => { let { inputs: i, outputCount: s } = e, o = wm({ ...r, outputCount: s }); if (et.webgpu.validateInputContent && gm(i, o), r.trainingMode) throw new Error("BatchNormalization trainingMode is not supported yet."); e.compute(ym(i, o)) }
}), vm, _m, H0, V_ = ne(() => {
  Pe(), Me(), vm = e => { if (e[0].dims.length !== 3) throw new Error("input should have 3 dimensions"); if (![320, 640, 1280].includes(e[0].dims[2])) throw new Error("number of channels should be 320, 640 or 1280"); if (e[1].dims.length !== 1) throw new Error("bias is expected to have 1 dimensions"); if (e[0].dims[2] !== e[1].dims[0]) throw new Error("last dimension of input and bias are not the same") }, _m = e => {
    let r = e[0].dims, i = e[0].dims[2], s = Q.size(r) / 4, o = e[0].dataType, d = X("input", o, r, 4), u = X("bias", o, [i], 4), h = X("residual", o, r, 4), m = _e("output", o, r, 4); return {
      name: "BiasAdd", getRunData: () => ({ outputs: [{ dims: r, dataType: e[0].dataType }], dispatchGroup: { x: Math.ceil(s / 64) } }), getShaderSource: g => `
  ...
  }, H0 = e => { vm(e.inputs), e.compute(_m(e.inputs)) }
}), $m, Ve, q0, G0, K0, Q0, Y0, Z0, X0, J0, ew, xm, tw, nw, rw, iw, Qs, aw, Hu, sw, ow, uw, lw, dw, cw, fw, pw, hw, mw, gw, yw, ww, vw, _w, $w, tc, xw, Bc, Dc, bw, Sw, kw, bm, Sm, Ew, cf = ne(() => {
  Ae(), Pe(), gt(), Me(), $m = (e, r, i, s, o, d, u) => {
    let h = Math.ceil(r / 4), m = ""; typeof o == "string" ? m = `${o}(a)` : m = o("a"); let g = X("inputData", i, [h], 4), _ = _e("outputData", s, [h], 4), v = [{ name: "vec_size", type: "u32" }]; return u && v.push(...u), `
...
`, Sm = e => `quick_gelu_impl(${e})`, Ew = (e, r) => { let i = Pt(e.inputs[0].dataType); e.compute(Ve(e.inputs[0], "QuickGelu", Sm, bm(i, r.alpha), r.cacheKey, e.inputs[0].dataType)) }
}), km, Em, Cw, H_ = ne(() => {
  Pe(), Me(), cf(), km = e => { if (e[0].dims.length !== 3) throw new Error("input should have 3 dimensions"); if (![2560, 5120, 10240].includes(e[0].dims[2])) throw new Error("hidden state should be 2560, 5120 or 10240"); if (e[1].dims.length !== 1) throw new Error("bias is expected to have 1 dimensions"); if (e[0].dims[2] !== e[1].dims[0]) throw new Error("last dimension of input and bias are not the same") }, Em = e => {
    let r = e[0].dims.slice(); r[2] = r[2] / 2; let i = X("input", e[0].dataType, e[0].dims, 4), s = X("bias", e[0].dataType, [e[0].dims[2]], 4), o = _e("output", e[0].dataType, r, 4), d = Q.size(r) / 4, u = vt(e[0].dataType); return {
      name: "BiasSplitGelu", getRunData: () => ({ outputs: [{ dims: r, dataType: e[0].dataType }], dispatchGroup: { x: Math.ceil(d / 64) } }), getShaderSource: h => `
  ...
  }, Cw = e => { km(e.inputs), e.compute(Em(e.inputs)) }
}), Cm, Tm, Pn, Tw, Iw, zw, Aw, Rw, Ow, Pw, Mw, Bw, Dw, q_ = ne(() => {
  Ae(), Pe(), Me(), Cm = (e, r, i, s, o, d, u, h, m, g, _, v) => {
    let f, b; typeof h == "string" ? f = b = (C, O) => `${h}((${C}),(${O}))` : typeof h == "function" ? f = b = h : (f = h.scalar, b = h.vector); let x = _e("outputData", _, s.length, 4), S = X("aData", m, r.length, 4), T = X("bData", g, i.length, 4), A; if (o) if (d) {
      let C = Q.size(r) === 1, O = Q.size(i) === 1, R = r.length > 0 && r[r.length - 1] % 4 === 0, M = i.length > 0 && i[i.length - 1] % 4 === 0; C || O ? A = x.setByOffset("global_idx", b(C ? `${S.type.value}(${S.getByOffset("0")}.x)` : S.getByOffset("global_idx"), O ? `${T.type.value}(${T.getByOffset("0")}.x)` : T.getByOffset("global_idx"))) : A = `
          ...
          `} else A = x.setByOffset("global_idx", b(S.getByOffset("global_idx"), T.getByOffset("global_idx"))); else {
      if (!d) throw new Error("no necessary to use scalar implementation for element-wise binary op implementation."); let C = (O, R, M = "") => {
        let W = `aData[indexA${R}][componentA${R}]`, U = `bData[indexB${R}][componentB${R}]`; return `
...
}), Im, zm, Am, Rm, Nw, Lw, G_ = ne(() => {
  Ae(), Pe(), gt(), Me(), Im = (e, r) => { if (!e || e.length < 1) throw new Error("too few inputs"); let i = 0, s = e[i], o = s.dataType, d = s.dims.length; e.forEach((u, h) => { if (h !== i) { if (u.dataType !== o) throw new Error("input tensors should be one type"); if (u.dims.length !== d) throw new Error("input tensors should have the same shape"); u.dims.forEach((m, g) => { if (g !== r && m !== s.dims[g]) throw new Error("non concat dimensions must match") }) } }) }, zm = (e, r) => `
...
`)
  ...
  ${S.mainStart()}
    ...
    ${Am(u, v)}
  }`; return { name: "Concat", shaderCache: { hint: `${r}`, inputDependencies: m }, getRunData: () => ({ outputs: [{ dims: i, dataType: s }], dispatchGroup: { x: Math.ceil(o / 64) }, programUniforms: _ }), getShaderSource: x }
  }, Nw = (e, r) => { let i = e.inputs, s = i[0].dims, o = Q.normalizeAxis(r.axis, s.length); Im(i, o); let d = s.slice(); d[o] = i.reduce((h, m) => h + (m.dims.length > o ? m.dims[o] : 0), 0); let u = i.filter(h => Q.size(h.dims) > 0); e.compute(Rm(u, o, d, i[0].dataType), { inputs: u }) }, Lw = e => Ze({ axis: e.axis })
}), qr, Gr, Kr, ff, Yr = ne(() => {
  Ae(), Pe(), qr = (e, r, i = "f32") => {
    switch (e.activation) {
      case "Relu": return `value = max(value, ${r}(0.0));`; case "Sigmoid": return `value = (${r}(1.0) / (${r}(1.0) + exp(-value)));`; case "Clip": return `value = clamp(value, ${r}(${i}(uniforms.clip_min)), ${r}(${i}(uniforms.clip_max)));`; case "HardSigmoid": return `value = max(${r}(0.0), min(${r}(1.0), ${i}(uniforms.alpha) * value + ${i}(uniforms.beta)));`; case "LeakyRelu": return `value = select(${i}(uniforms.alpha) * value, value, value >= ${r}(0.0));`; case "Tanh": return `let e2x = exp(-2.0 * abs(value));
              value = sign(value) * (1.0 - e2x) / (1.0 + e2x);
        `; case "": return ""; default: throw new Error(`Unsupported activation ${e.activation}`)
    }
  }, Gr = (e, r) => { e.activation === "Clip" ? r.push({ type: 1, data: e.clipMax }, { type: 1, data: e.clipMin }) : e.activation === "HardSigmoid" ? r.push({ type: 1, data: e.alpha }, { type: 1, data: e.beta }) : e.activation === "LeakyRelu" && r.push({ type: 1, data: e.alpha }) }, Kr = (e, r) => { e.activation === "Clip" ? r.push({ name: "clip_max", type: "f32" }, { name: "clip_min", type: "f32" }) : e.activation === "HardSigmoid" ? r.push({ name: "alpha", type: "f32" }, { name: "beta", type: "f32" }) : e.activation === "LeakyRelu" && r.push({ name: "alpha", type: "f32" }) }, ff = e => { let r = (e == null ? void 0 : e.activation) || ""; if (r === "HardSigmoid") { let [i, s] = (e == null ? void 0 : e.activation_params) || [.2, .5]; return { activation: r, alpha: i, beta: s } } else if (r === "Clip") { let [i, s] = (e == null ? void 0 : e.activation_params) || [g0, y0]; return { activation: r, clipMax: s, clipMin: i } } else if (r === "LeakyRelu") { let [i] = (e == null ? void 0 : e.activation_params) || [.01]; return { activation: r, alpha: i } } return { activation: r } }
}), Mt, pf, il = ne(() => {
  Mt = (e, r) => { switch (e) { case 1: return r; case 2: return `vec2<${r}>`; case 3: return `vec3<${r}>`; case 4: return `vec4<${r}>`; default: throw new Error(`${e}-component is not supported.`) } }, pf = e => `
...
`}), Om, Pm, Ju, nc, Mm, el, Bm, mf, al = ne(() => {
      Ae(), Pe(), Me(), Yr(), il(), Om = (e, r) => e ? `
        ...
        }`, Ju = (e, r, i = "f32", s, o = !1, d = 32, u = !1, h = 32) => {
        let m = r[1] * e[1], g = r[0] * e[0], _ = o ? m : d, v = o ? d : m, f = _ / r[0], b = d / r[1]; if (!((o && f === 4 && e[1] === 4 || !o && (f === 3 || f === 4)) && _ % r[0] === 0 && d % r[1] === 0 && e[0] === 4)) throw new Error(`If transposeA ${o} is true, innerElementSize ${f} and workPerThread[1] ${e[1]} must be 4.
...
fn main(@builtin(local_invocation_id) localId : vec3<u32>,
  ...
  for (var innerRow = 0; innerRow < rowPerThread; innerRow = innerRow + 1) {
      mm_write(batch, globalRow + innerRow, globalCol, acc[innerRow]);
            ...
            `, Mm = e => e ? "let ACached = mm_Asub[k][tileRow + innerRow];" : "let ACached = mm_Asub[tileRow + innerRow][k];", el = (e, r, i = "f32", s, o = !1, d = 32, u = !1, h = 32, m = !1) => {
        let g = e[1] * r[1], _ = e[0] * r[0], v = o ? g : d, f = o ? d : g; if (!(f % r[1] === 0 && v % r[0] === 0 && d % r[1] === 0)) throw new Error(`tileAHight ${f} must be divisible by workgroupSize[1]${r[1]}, tileAWidth ${v} must be divisible by workgroupSize[0]${r[0]}, tileInner ${d} must be divisible by workgroupSize[1]${r[1]}`); let b = f / r[1], x = v / r[0], S = d / r[1], T = m ? `
    let localRow = i32(localId.y);
...
`}, Bm = (e, r, i, s, o, d = !1) => {
        let [u, h, m] = o, [g, _, v, f] = s, b = Zs(u, m), x = Zs(h, m), S = vt(s[0].type.tensor), T = () => {
          let C = _.rank, O = g.rank, R = `var aIndices: ${_.type.indices};`; for (let M = C - 2 - 1, W = O - 1; M >= 0; M--, W--)R += `
aIndices[${M}] = ${O > 1 ? `batchIndices[${W}]` : "batchIndices"};`; return b.forEach(M => {
            R += `
aIndices[${M}] = 0;`
          }), R += `
aIndices[${C - 2}] = u32(row);
                   aIndices[${C - 1}] = u32(colIn);`, R
        }, A = () => {
          let C = v.rank, O = g.rank, R = `var bIndices: ${v.type.indices};`; for (let M = C - 2 - 1, W = O - 1; M >= 0; M--, W--)R += `
bIndices[${M}] = ${O > 1 ? `batchIndices[${W}]` : "batchIndices"};`; return x.forEach(M => {
            R += `
bIndices[${M}] = 0;`
          }), R += `
bIndices[${C - 2}] = u32(row);
                   bIndices[${C - 1}] = u32(colIn);`, R
        }; return `
    ...
    `}, mf = (e, r, i, s, o = !1, d) => {
        let u = e[0].dims, h = e[1].dims, m = u.slice(0, -2), g = h.slice(0, -2), _ = s ? s.slice(0, -2) : i.slice(0, -2), v = Q.size(_), f = u[u.length - 2], b = u[u.length - 1], x = h[h.length - 1], S = b % 4 === 0 && x % 4 === 0, T = f <= 8 ? [4, 1, 1] : [4, 4, 1], A = [8, 8, 1], C = [Math.ceil(x / A[0] / T[0]), Math.ceil(f / A[1] / T[1]), Math.ceil(v / A[2] / T[2])], O = S ? 4 : 1, R = [...m, f, b / O], M = R.length, W = [...g, b, x / O], U = W.length, Y = [v, f, x / O], ae = [{ type: 6, data: f }, { type: 6, data: x }, { type: 6, data: b }]; Gr(r, ae), ae.push(...he(_, R, W)); let oe = ["rank", "rank"], $e = e.length > 2; $e && (ae.push(...he(e[2].dims)), oe.push("rank")), ae.push(...he(Y)); let xe = de => {
    ...
    fn mm_write(batch: i32, row : i32, colIn : i32, valueIn : ${M}) {
      ...
      setOutputAtCoords(coords[0], coords[1], coords[2], coords[3], value);
        ...
        let g = r.format === "NHWC", _ = g ? e[0].dims[3] : e[0].dims[1], v = i[0], f = g ? i[2] : i[3], b = g ? i[1] : i[2], x = g ? i[3] : i[1], S = g && (_ % 4 === 0 || _ % 3 === 0) && x % 4 === 0, T = g ? x : f * b, A = g ? f * b : x, C = [8, 8, 1], O = s <= 8 ? [4, 1, 1] : [4, 4, 1], R = [Math.ceil(T / C[0] / O[0]), Math.ceil(A / C[1] / O[1]), Math.ceil(v / C[2] / O[2])]; Ye("verbose", () => `[conv2d_mm_webgpu] dispatch = ${R}`); let M = S ? g && _ % 4 !== 0 ? 3 : 4 : 1, W = C[1] * O[1], U = C[0] * O[0], Y = Math.max(C[0] * M, C[1]), ae = s % W === 0, oe = o % U === 0, $e = d % Y === 0, xe = S ? [M, 4, 4] : [1, 1, 1], de = [{ type: 6, data: s }, { type: 6, data: o }, { type: 6, data: d }, { type: 6, data: [r.pads[0], r.pads[1]] }, { type: 6, data: r.strides }, { type: 6, data: r.dilations }]; Gr(r, de), de.push(...he(e[0].dims, e[1].dims)); let Re = ["rank", "rank"]; u && (de.push(...he(e[2].dims)), Re.push("rank")), de.push(...he(i)); let Be = be => {
          let Ee = [{ name: "dim_a_outer", type: "i32" }, { name: "dim_b_outer", type: "i32" }, { name: "dim_inner", type: "i32" }, { name: "pad", type: "i32", length: 2 }, { name: "stride", type: "i32", length: 2 }, { name: "dilation", type: "i32", length: 2 }]; Kr(r, Ee); let G = S ? 4 : 1, H = vt(e[0].dataType), Z = `
      ...
      }`, z = X("x", e[0].dataType, e[0].dims.length, M === 3 ? 1 : M), N = X("w", e[1].dataType, e[1].dims.length, G), re = [z, N], ce = _e("result", e[0].dataType, i.length, G); if (u) {
            let ve = X("bias", e[2].dataType, e[2].dims.length, G); re.push(ve), Z += `
      ...
      Ae(), Yn(), Pe(), Me(), Yr(), il(), Nm = e => { let r = 1; for (let i = 0; i < e.length; i++)r *= e[i]; return r }, rc = e => typeof e == "number" ? [e, e, e] : e, Us = (e, r) => r <= 1 ? e : e + (e - 1) * (r - 1), Lm = (e, r, i, s = 1) => { let o = Us(r, s); return Math.floor((e[0] * (i - 1) - i + o) / 2) }, ic = (e, r, i, s, o) => { o == null && (o = Lm(e, r[0], s[0])); let d = [0, 0, 0, i]; for (let u = 0; u < 3; u++)e[u] + 2 * o >= r[u] && (d[u] = Math.trunc((e[u] - r[u] + 2 * o) / s[u] + 1)); return d }, Um = (e, r, i, s, o, d, u, h, m, g) => { let _, v, f, b; if (e === "VALID" && (e = 0), typeof e == "number") { _ = { top: e, bottom: e, left: e, right: e, front: e, back: e }; let x = ic([r, i, s, 1], [h, m, g], 1, [o, d, u], e); v = x[0], f = x[1], b = x[2] } else if (Array.isArray(e)) { if (!e.every((S, T, A) => S === A[0])) throw Error(`Unsupported padding parameter: ${e}`); _ = { top: e[0], bottom: e[1], left: e[2], right: e[3], front: e[4], back: e[5] }; let x = ic([r, i, s, 1], [h, m, g], 1, [o, d, u], e[0]); v = x[0], f = x[1], b = x[2] } else if (e === "SAME_UPPER") { v = Math.ceil(r / o), f = Math.ceil(i / d), b = Math.ceil(s / u); let x = (v - 1) * o + h - r, S = (f - 1) * d + m - i, T = (b - 1) * u + g - s, A = Math.floor(x / 2), C = x - A, O = Math.floor(S / 2), R = S - O, M = Math.floor(T / 2), W = T - M; _ = { top: O, bottom: R, left: M, right: W, front: A, back: C } } else throw Error(`Unknown padding parameter: ${e}`); return { padInfo: _, outDepth: v, outHeight: f, outWidth: b } }, Fw = (e, r, i, s, o, d = !1, u = "channelsLast") => { let h, m, g, _, v; if (u === "channelsLast") [h, m, g, _, v] = e; else if (u === "channelsFirst") [h, v, m, g, _] = e; else throw new Error(`Unknown dataFormat ${u}`); let [f, , b, x, S] = r, [T, A, C] = rc(i), [O, R, M] = rc(s), W = Us(b, O), U = Us(x, R), Y = Us(S, M), { padInfo: ae, outDepth: oe, outHeight: $e, outWidth: xe } = Um(o, m, g, _, T, A, C, W, U, Y), de = d ? f * v : f, Re = [0, 0, 0, 0, 0]; return u === "channelsFirst" ? Re = [h, de, oe, $e, xe] : u === "channelsLast" && (Re = [h, oe, $e, xe, de]), { batchSize: h, dataFormat: u, inDepth: m, inHeight: g, inWidth: _, inChannels: v, outDepth: oe, outHeight: $e, outWidth: xe, outChannels: de, padInfo: ae, strideDepth: T, strideHeight: A, strideWidth: C, filterDepth: b, filterHeight: x, filterWidth: S, effectiveFilterDepth: W, effectiveFilterHeight: U, effectiveFilterWidth: Y, dilationDepth: O, dilationHeight: R, dilationWidth: M, inShape: e, outShape: Re, filterShape: r } }, Ww = (e, r, i, s, o, d) => {
        let u = d === "channelsLast"; u ? e[0].dims[3] : e[0].dims[1]; let h = [64, 1, 1], m = { x: i.map((T, A) => A) }, g = [Math.ceil(Nm(m.x.map(T => i[T])) / h[0]), 1, 1]; Ye("verbose", () => `[conv3d_naive_webgpu] dispatch = ${g}`); let _ = 1, v = Q.size(i), f = [{ type: 12, data: v }, { type: 12, data: s }, { type: 12, data: o }, { type: 12, data: r.strides }, { type: 12, data: r.dilations }]; Gr(r, f), f.push(...he(e[0].dims, e[1].dims)); let b = ["rank", "rank"], x = e.length === 3; x && (f.push(...he(e[2].dims)), b.push("rank")), f.push(...he(i)); let S = T => {
          let A = [{ name: "output_size", type: "u32" }, { name: "filter_dims", type: "u32", length: s.length }, { name: "pads", type: "u32", length: o.length }, { name: "strides", type: "u32", length: r.strides.length }, { name: "dilations", type: "u32", length: r.dilations.length }]; Kr(r, A); let C = 1, O = vt(e[0].dataType), R = X("x", e[0].dataType, e[0].dims.length, _), M = X("W", e[1].dataType, e[1].dims.length, C), W = [R, M], U = _e("result", e[0].dataType, i.length, C), Y = ""; if (x) {
            let $e = X("bias", e[2].dataType, e[2].dims.length, C); W.push($e), Y += `
        fn getBiasByOutputCoords(coords : array<u32, 5>) -> ${O} {
          ...
          }`}; return { name: "Conv3DNaive", shaderCache: { hint: `${r.cacheKey};${u};${_};${x}`, inputDependencies: b }, getRunData: () => ({ outputs: [{ dims: i, dataType: e[0].dataType }], dispatchGroup: { x: g[0], y: g[1], z: g[2] }, programUniforms: f }), getShaderSource: S }
      }
    }), Vw, Hw, Y_ = ne(() => {
      Ae(), Pe(), Me(), Yr(), Vw = (e, r, i, s) => {
        let o = e.length > 2, d = o ? "value += b[output_channel];" : "", u = e[0].dims, h = e[1].dims, m = r.format === "NHWC", g = m ? i[3] : i[1], _ = g / r.group, v = m && _ >= 4 ? pt(g) : 1, f = Q.size(i) / v, b = [{ type: 12, data: f }, { type: 12, data: r.dilations }, { type: 12, data: [r.strides[0], r.strides[1]] }, { type: 12, data: [r.pads[0], r.pads[1]] }, { type: 12, data: _ }]; Gr(r, b), b.push(...he(u, [h[0], h[1], h[2], h[3] / v])); let x = o ? ["rank", "rank", "rank"] : ["rank", "rank"]; b.push(...he([i[0], i[1], i[2], i[3] / v])); let S = T => {
          let A = _e("output", e[0].dataType, i.length, v), C = vt(A.type.tensor), O = qr(r, A.type.value, C), R = X("x", e[0].dataType, u.length), M = X("w", e[1].dataType, h.length, v), W = [R, M]; o && W.push(X("b", e[2].dataType, e[2].dims, v)); let U = [{ name: "output_size", type: "u32" }, { name: "dilations", type: "u32", length: r.dilations.length }, { name: "strides", type: "u32", length: 2 }, { name: "pads", type: "u32", length: 2 }, { name: "output_channels_per_group", type: "u32" }]; Kr(r, U); let Y = m ? `
  ...
  }`}; return { name: "GroupedConv", shaderCache: { hint: `${r.cacheKey}_${v}`, inputDependencies: x }, getRunData: () => ({ outputs: [{ dims: s ? s(i) : i, dataType: e[0].dataType }], dispatchGroup: { x: Math.ceil(f / 64) }, programUniforms: b }), getShaderSource: S }
      }, Hw = (e, r, i, s) => {
        let o = e.length > 2, d = pt(i[3]), u = pt(i[2]), h = Q.size(i) / d / u, m = [e[0].dims[0], e[0].dims[1], e[0].dims[2], e[0].dims[3] / d], g = [e[1].dims[0], e[1].dims[1], e[1].dims[2], e[1].dims[3] / d], _ = [i[0], i[1], i[2], i[3] / d], v = [{ type: 12, data: h }, { type: 6, data: [r.strides[0], r.strides[1]] }, { type: 6, data: [r.pads[0], r.pads[1]] }]; Gr(r, v), v.push(...he(m, g, _)); let f = (u - 1) * r.strides[1] + g[1], b = x => {
          let S = _e("output", e[0].dataType, _.length, d), T = vt(S.type.tensor), A = qr(r, S.type.value, T), C = X("x", e[0].dataType, m.length, d), O = X("w", e[1].dataType, g.length, d), R = [C, O]; o && R.push(X("b", e[2].dataType, e[2].dims, d)); let M = o ? "value += b[output_channel];" : "", W = [{ name: "output_size", type: "u32" }, { name: "strides", type: "i32", length: 2 }, { name: "pads", type: "i32", length: 2 }]; return Kr(r, W), `
  ...
  }`}; return { name: "GroupedConv-Vectorize", shaderCache: { hint: `${r.cacheKey};${d};${u};${f};${g[0]};${g[1]}`, inputDependencies: o ? ["rank", "rank", "type"] : ["rank", "rank"] }, getRunData: () => ({ outputs: [{ dims: s ? s(i) : i, dataType: e[0].dataType }], dispatchGroup: { x: Math.ceil(h / 64) }, programUniforms: v }), getShaderSource: b }
      }
    }), Nc, jm, qw, Gw = ne(() => {
      Ae(), Pe(), al(), Me(), Yr(), Nc = (e, r, i, s, o = !1, d) => {
        let u = e[0].dims, h = e[1].dims, m = u[u.length - 2], g = h[h.length - 1], _ = u[u.length - 1], v = pt(g), f = pt(_), b = pt(m), x = Q.size(i) / v / b, S = e.length > 2, T = s ? s.slice(0, -2) : i.slice(0, -2), A = [Q.size(T), m, g], C = [{ type: 12, data: x }, { type: 12, data: m }, { type: 12, data: g }, { type: 12, data: _ }]; Gr(r, C), C.push(...he(T, u, h)), S && C.push(...he(e[2].dims)), C.push(...he(A)); let O = R => {
          let M = uf("batch_dims", e[0].dataType, T.length), W = X("a", e[0].dataType, u.length, f), U = X("b", e[1].dataType, h.length, v), Y = _e("output", e[0].dataType, A.length, v), ae = vt(Y.type.tensor), oe = qr(r, Y.type.value, ae), $e = [W, U], xe = ""; if (S) { let Z = o ? v : 1; $e.push(X("bias", e[2].dataType, e[2].dims.length, Z)), xe = `${o ? `value += bias[col / ${Z}];` : `value += ${Y.type.value}(bias[row + i]);`}` } let de = u.slice(0, -2), Re = h.slice(0, -2), Be = Zs(de, T), be = Zs(Re, T), Ee = [{ name: "output_size", type: "u32" }, { name: "M", type: "u32" }, { name: "N", type: "u32" }, { name: "K", type: "u32" }]; Kr(r, Ee); let G = (Z, z) => {
            let N = Z.rank, re = Z.name; if (N === 2) return `var ${re}_indices = ${Z.type.indices}(0u, 0u);`; let ce = M.rank, ve = `var ${re}_indices: ${Z.type.indices};`; for (let Ce = N - 2 - 1, Fe = ce - 1; Ce >= 0; Ce--, Fe--)ve += `
${re}_indices[${Ce}] = ${ce > 1 ? `batch_indices[${Fe}]` : "batch_indices"};`; return z.forEach(Ce => {
              ve += `
${re}_indices[${Ce}] = 0;`
            }), ve += `${re}_indices[${N - 2}] = 0u;
                     ${re}_indices[${N - 1}] = 0u;`, ve
          }, H = () => {
            let Z = `var a_data: ${W.type.value};`; for (let z = 0; z < f; z++)Z += `
              let b_data${z} = b[(b_offset + (k + ${z}) * uniforms.N + col) / ${v}];`; for (let z = 0; z < b; z++) {
              Z += `a_data = a[(a_offset + (row + ${z}) * uniforms.K + k) / ${f}];`; for (let N = 0; N < f; N++)Z += `
      ...
      Ae(), Yn(), Me(), Yr(), il(), Uw(), al(), qm = (e, r = !1, i, s, o = 4) => {
        let d = T => {
          switch (T) {
            ...
            `; default: throw new Error(`innerElementSize ${T} is not supported.`)
          }
        }, u = e ? `
    ...
    if (row < uniforms.dim_a_outer && col < uniforms.dim_b_outer) {
      ...
      result[getIndexFromCoords4D(coords, vec4<i32>(uniforms.result_shape))/${o}] = value;
        ...
        let m = r.format === "NHWC", g = m ? e[0].dims[3] : e[0].dims[1], _ = i[0], v = m ? i[2] : i[3], f = m ? i[1] : i[2], b = m ? i[3] : i[1], x = m && g % 4 === 0 && g % 3 && b % 4 === 0, S = m ? b : v * f, T = m ? v * f : b, A = [8, 8, 1], C = s <= 8 ? [4, 1, 1] : [4, 4, 1], O = [Math.ceil(S / A[0] / C[0]), Math.ceil(T / A[1] / C[1]), Math.ceil(_ / A[2] / C[2])]; Ye("verbose", () => `[conv_backprop_mm_webgpu] dispatch = ${O}`); let R = x ? 4 : 1, M = Math.max(A[0] * R, A[1]), W = x ? 4 : 1, U = [r.kernelShape[m ? 1 : 2], r.kernelShape[m ? 2 : 3]], Y = [U[0] + (r.dilations[0] <= 1 ? 0 : (U[0] - 1) * (r.dilations[0] - 1)), U[1] + (r.dilations[1] <= 1 ? 0 : (U[1] - 1) * (r.dilations[1] - 1))], ae = [Y[0] - 1 - Math.floor((r.pads[0] + r.pads[2]) / 2), Y[1] - 1 - Math.floor((r.pads[1] + r.pads[3]) / 2)], oe = [{ type: 6, data: s }, { type: 6, data: o }, { type: 6, data: d }, { type: 6, data: r.strides }, { type: 6, data: r.dilations }, { type: 6, data: U }, { type: 6, data: ae }]; Gr(r, oe), oe.push(...he(e[0].dims, e[1].dims)); let $e = ["rank", "rank"]; u && (oe.push(...he(e[2].dims)), $e.push("rank")), oe.push(...he(i)); let xe = de => {
          let Re = X("x", e[0].dataType, e[0].dims.length, W), Be = X("w", e[1].dataType, e[1].dims.length, 1), be = _e("result", e[0].dataType, i.length, W), Ee = [Re, Be], G = ""; if (u) {
            let z = X("bias", e[2].dataType, e[2].dims.length, W); Ee.push(z), G += `
        ...
        ${x ? Ju(C, A, Z, void 0, !m, M) : el(C, A, Z, void 0, !m, M, !1, void 0, h)}`
        }; return { name: "Conv2DTransposeMatMul", shaderCache: { hint: `${r.cacheKey};${C};${A};${x}`, inputDependencies: $e }, getRunData: () => ({ outputs: [{ dims: i, dataType: e[0].dataType }], dispatchGroup: { x: O[0], y: O[1], z: O[2] }, programUniforms: oe }), getShaderSource: xe }
      }
    }), Gm, jc, J_ = ne(() => {
      Ae(), Yn(), Pe(), Me(), Gm = (e, r, i, s, o, d = !1, u, h, m = !1) => {
        let g = m ? 1 : 2, _ = m ? 2 : 3, v = m ? 3 : 1, f = d ? 2 : 1, b = `
      ...
      Ae(), Pe(), gt(), Me(), tg = (e, r, i, s) => {
        let o = Q.size(r), d = r.length, u = X("input", e, d), h = _e("output", e, d), m = i.dataType === 6 ? i.getInt32Array()[0] : Number(i.getBigInt64Array()[0]), g = Q.normalizeAxis(m, d), _ = v => {
          let f = ` i32(${u.indicesGet("inputIndices", "uniforms.axis")}) `, b = ge("uniforms.input_shape", "uniforms.axis", d), x = s.reverse ? f + (s.exclusive ? " + 1" : "") : "0", S = s.reverse ? b : f + (s.exclusive ? "" : " + 1"); return `
                ...
                }`}; return { name: "CumSum", shaderCache: { hint: s.cacheKey, inputDependencies: ["rank"] }, getRunData: () => ({ outputs: [{ dims: r, dataType: e }], dispatchGroup: { x: Math.ceil(o / 64) }, programUniforms: [{ type: 12, data: o }, { type: 12, data: g }, ...he(r, r)] }), getShaderSource: _ }
      }, Zw = (e, r) => { let i = e.inputs[0].dims, s = e.inputs[0].dataType, o = e.inputs[1]; e.compute(tg(s, i, o, r), { inputs: [0] }) }, Xw = e => { let r = e.exclusive === 1, i = e.reverse === 1; return Ze({ exclusive: r, reverse: i }) }
    }), ng, rg, ig, Jw, ev, n2 = ne(() => {
      Ae(), Pe(), gt(), Me(), ng = e => { if (!e || e.length !== 1) throw new Error("DepthToSpace requires 1 input."); if (e[0].dims.length !== 4) throw new Error("DepthToSpace requires 4D input.") }, rg = (e, r, i, s) => {
        let o = []; o.push(`fn perm(i: ${s.type.indices}) -> ${i.type.indices} {
...
`)};
          ...
          }`}; return { name: "Einsum", shaderCache: { hint: i.equation, inputDependencies: e.map(() => "rank") }, getRunData: () => { let g = h.filter(v => i.symbolToInfo.has(v)).map(v => { var f; return { type: 12, data: ((f = i.symbolToInfo.get(v)) == null ? void 0 : f.dimValue) || 0 } }); g.push({ type: 12, data: d }); let _ = e.map((v, f) => [...he(v)]).reduce((v, f) => v.concat(f), g); return _.push(...he(s)), { outputs: [{ dims: s, dataType: r }], dispatchGroup: { x: Math.ceil(d / 64) }, programUniforms: _ } }, getShaderSource: m }
      }, tv = (e, r) => { let i = new ug(e.inputs, r.equation), s = i.outputDims, o = e.inputs.map((d, u) => d.dims); e.compute(lg(o, e.inputs[0].dataType, i, s)) }, nv = e => { let r = e.equation.replace(/\s+/g, ""); return Ze({ equation: r }) }
    }), dg, lc, cg, fg, rv, i2 = ne(() => {
      Ae(), Pe(), Me(), dg = e => { if (!e || e.length !== 2) throw new Error("Expand requires 2 input."); let r = e[0].dims, i = Array.from(e[1].getBigInt64Array(), Number), s = i.length < r.length ? 0 : i.length - r.length, o = r.length < i.length ? 0 : r.length - i.length; for (; s < i.length && o < r.length; ++s, ++o)if (i[s] !== r[o] && i[s] !== 1 && r[o] !== 1) throw new Error("Expand requires shape to be broadcastable to input") }, lc = (e, r) => { let i = e.length - r.length, s = []; for (let o = 0; o < i; ++o)s.push(e[o]); for (let o = 0; o < r.length; ++o)s.push(r[o] === 1 ? e[o + i] : r[o]); return s }, cg = (e, r) => e.length > r.length ? lc(e, r) : lc(r, e), fg = e => {
        let r = e[0].dims, i = Array.from(e[1].getBigInt64Array(), Number), s = cg(r, i), o = e[0].dataType, d = o === 9 ? 4 : 1, u = Math.ceil(Q.size(s) / d), h = g => {
          let _ = X("input", o, r.length, d), v = _e("output", o, s.length, d), f; if (o === 9) {
            let b = (x, S, T = "") => `
    ...
    ${f}`
        }, m = [{ type: 12, data: u }, ...he(r, s)]; return { name: "Expand", shaderCache: { hint: `${s.length}`, inputDependencies: ["rank"] }, getShaderSource: h, getRunData: () => ({ outputs: [{ dims: s, dataType: e[0].dataType }], dispatchGroup: { x: Math.ceil(u / 64) }, programUniforms: m }) }
      }, rv = e => { dg(e.inputs), e.compute(fg(e.inputs), { inputs: [0] }) }
    }), pg, iv, a2 = ne(() => {
      Ae(), Pe(), Me(), cf(), pg = e => {
        let r = e[0].dataType, i = Q.size(e[0].dims), s = Q.size(e[1].dims), o = s % 4 === 0, d = u => {
          let h = X("x", r, [1], 4), m = X("bias", r, [1], 4), g = _e("y", r, [1], 4), _ = [{ name: "output_vec_size", type: "u32" }, { name: "bias_size", type: "u32" }], v = b => `
    ...
    ${u.mainStart(Ra)}
    ...
    }`}; return { name: "FastGeluWithBias", shaderCache: { hint: `${o}`, inputDependencies: ["type", "type"] }, getShaderSource: d, getRunData: u => ({ outputs: [{ dims: u[0].dims, dataType: u[0].dataType }], programUniforms: [{ type: 12, data: Math.ceil(i / 4) }, { type: 12, data: s }], dispatchGroup: { x: Math.ceil(i / Ra / 4) } }) }
      }, iv = e => { e.inputs.length < 2 || Q.size(e.inputs[1].dims) === 0 ? bw(e) : e.compute(pg(e.inputs)) }
    }), hg, mg, av, sv, s2 = ne(() => {
      Ae(), Pe(), gt(), Me(), hg = e => { if (!e || e.length !== 2) throw new Error("Gather requires 2 inputs.") }, mg = (e, r) => {
        let i = e[0].dims, s = e[1].dims, o = i.length, d = Q.normalizeAxis(r.axis, o), u = i.slice(0); u.splice(d, 1, ...s); let h = i[d], m = e[0].dataType === 9 ? 4 : 1, g = Math.ceil(Q.size(u) / m), _ = [{ type: 12, data: g }, { type: 6, data: h }, { type: 12, data: d }, ...he(e[0].dims, e[1].dims, u)], v = f => {
          let b = X("data", e[0].dataType, e[0].dims.length, m), x = X("inputIndices", e[1].dataType, e[1].dims.length), S = _e("output", e[0].dataType, u.length, m), T = C => {
            let O = s.length, R = `var indicesIndices${C}  = ${x.type.indices}(0);`; for (let M = 0; M < O; M++)R += `${O > 1 ? `indicesIndices${C}[${M}]` : `indicesIndices${C}`} = ${u.length > 1 ? `outputIndices${C}[uniforms.axis + ${M}]` : `outputIndices${C}`};`; R += `
          var idx${C} = ${x.getByIndices(`indicesIndices${C}`)};
          if (idx${C} < 0) {
            idx${C} = idx${C} + uniforms.axisDimLimit;
          }
          var dataIndices${C} : ${b.type.indices};
        `; for (let M = 0, W = 0; M < o; M++)M === d ? (R += `${o > 1 ? `dataIndices${C}[${M}]` : `dataIndices${C}`} = u32(idx${C});`, W += O) : (R += `${o > 1 ? `dataIndices${C}[${M}]` : `dataIndices${C}`} = ${u.length > 1 ? `outputIndices${C}[${W}]` : `outputIndices${C}`};`, W++); return R
          }, A; if (e[0].dataType === 9) {
            let C = (O, R, M = "") => `
      ...
      ${f.mainStart()}
        ...
        ${A}
      }`}; return { name: "Gather", shaderCache: { hint: r.cacheKey, inputDependencies: ["rank", "rank"] }, getRunData: () => ({ outputs: [{ dims: u, dataType: e[0].dataType }], dispatchGroup: { x: Math.ceil(g / 64) }, programUniforms: _ }), getShaderSource: v }
      }, av = e => Ze({ axis: e.axis }), sv = (e, r) => { let i = e.inputs; hg(i), e.compute(mg(e.inputs, r)) }
    }), gg, yg, ov, uv, o2 = ne(() => {
      Ae(), Pe(), gt(), Me(), gg = (e, r) => { if (e.length < 3 || e.length > 4) throw new Error("GatherBlockQuantized requires 3 or 4 inputs."); let i = Q.normalizeAxis(r.quantizeAxis, e[0].dims.length), s = r.blockSize, o = e[0], d = e[2], u = e.length === 4 ? e[3] : void 0; if (d.dims.length !== o.dims.length || !o.dims.map((h, m) => m === i ? Math.ceil(h / s) === d.dims[m] : h === d.dims[m]).reduce((h, m) => h && m, !0)) throw new Error("Scales must have the same rank as the input tensor and the dims should match except on gatherAxis."); if (u) { if (u.dataType !== o.dataType) throw new Error("Zero point must have the same data type as the input tensor."); if (u.dims.length !== d.dims.length || !u.dims.map((h, m) => h === d.dims[m]).reduce((h, m) => h && m, !0)) throw new Error("Zero point must have the same rank as the input tensor and the dims should match except on quantizeAxis.") } }, yg = (e, r) => {
        let i = e[0].dims, s = e[1].dims, o = i.length, d = Q.normalizeAxis(r.gatherAxis, o), u = Q.normalizeAxis(r.quantizeAxis, o), h = i.slice(0); h.splice(d, 1, ...s); let m = Q.size(h), g = e[2].dataType, _ = e[0].dataType === 22, v = [{ type: 12, data: m }, { type: 12, data: u }, { type: 12, data: d }, { type: 12, data: r.blockSize }, ...he(...e.map((b, x) => b.dims), h)], f = b => {
          let x = X("data", e[0].dataType, e[0].dims.length), S = X("inputIndices", e[1].dataType, e[1].dims.length), T = X("scales", e[2].dataType, e[2].dims.length), A = e.length > 3 ? X("zeroPoint", e[3].dataType, e[3].dims.length) : void 0, C = _e("output", g, h.length), O = [x, S, T]; A && O.push(A); let R = [{ name: "output_size", type: "u32" }, { name: "quantize_axis", type: "u32" }, { name: "gather_axis", type: "u32" }, { name: "block_size", type: "u32" }]; return `
    ...
    }`}; return { name: "GatherBlockQuantized", shaderCache: { hint: `${r.cacheKey};${e.filter((b, x) => x !== 1).map(b => b.dims.join("_")).join(";")}`, inputDependencies: Array.from({ length: e.length }, (b, x) => "rank") }, getRunData: () => ({ outputs: [{ dims: h, dataType: g }], dispatchGroup: { x: Math.ceil(m / 64) }, programUniforms: v }), getShaderSource: f }
      }, ov = (e, r) => { let i = e.inputs; gg(i, r), e.compute(yg(e.inputs, r)) }, uv = e => Ze({ blockSize: e.blockSize, gatherAxis: e.gatherAxis, quantizeAxis: e.quantizeAxis })
    }), wg, vg, lv, dv, u2 = ne(() => {
      Ae(), Pe(), gt(), Me(), wg = e => {
        ...
        let i = e[0].dims, s = e[0].dataType, o = i.length, d = e[1].dims, u = e[1].dataType, h = Q.normalizeAxis(r.axis, o), m = i[h], g = d.slice(0), _ = Q.size(g), v = X("input", s, o), f = X("indicesInput", u, d.length), b = _e("output", s, g.length), x = [{ type: 12, data: _ }, { type: 6, data: m }, { type: 12, data: h }]; return x.push(...he(i, d, g)), {
          name: "GatherElements", shaderCache: { inputDependencies: ["rank", "rank"] }, getRunData: () => ({ outputs: [{ dims: g, dataType: e[0].dataType }], dispatchGroup: { x: Math.ceil(_ / 64) }, programUniforms: x }), getShaderSource: S => `
      ...
      }, lv = e => Ze({ axis: e.axis }), dv = (e, r) => { let i = e.inputs; wg(i), e.compute(vg(e.inputs, r)) }
    }), _g, $g, fv, pv, l2 = ne(() => {
      Ae(), Pe(), Me(), _g = e => { if (!e) throw new Error("Input is missing"); if (e.length < 2 || e.length > 3) throw new Error("Invaid input number."); if (e.length === 3 && e[2].dims.length > 2) throw new Error("Invalid input shape of C"); if (e[0].dataType !== e[1].dataType || e.length === 3 && e[0].dataType !== e[2].dataType) throw new Error("Input types are mismatched") }, $g = (e, r) => {
        let i = e[0].dims.slice(), s = e[1].dims.slice(), [o, d, u] = m0.getShapeOfGemmResult(i, r.transA, s, r.transB, e.length === 3 ? e[2].dims : void 0), h = [o, d]; if (!h) throw new Error("Can't use gemm on the given tensors"); let m = Q.size(h), g = [{ type: 12, data: m }, { type: 12, data: o }, { type: 12, data: d }, { type: 12, data: u }, { type: 1, data: r.alpha }, { type: 1, data: r.beta }], _ = ["type", "type"]; e.length === 3 && (g.push(...he(e[2].dims)), _.push("rank")), g.push(...he(h)); let v = f => {
          let b = ""; r.transA && r.transB ? b = "value += a[k * uniforms.M + m] * b[n * uniforms.K + k];" : r.transA && !r.transB ? b = "value += a[k * uniforms.M + m] * b[k * uniforms.N + n];" : !r.transA && r.transB ? b = "value += a[m * uniforms.K + k] * b[n * uniforms.K + k];" : !r.transA && !r.transB && (b = "value += a[m * uniforms.K + k] * b[k * uniforms.N + n];"); let x = r.alpha === 1 ? "" : "value *= uniforms.alpha;", S = X("a", e[0].dataType, e[0].dims), T = X("b", e[1].dataType, e[1].dims), A = S.type.value, C = null, O = [S, T]; e.length === 3 && (C = X("c", e[2].dataType, e[2].dims.length), O.push(C)); let R = _e("output", e[0].dataType, h.length); O.push(R); let M = [{ name: "output_size", type: "u32" }, { name: "M", type: "u32" }, { name: "N", type: "u32" }, { name: "K", type: "u32" }, { name: "alpha", type: "f32" }, { name: "beta", type: "f32" }]; return `
  ...
  ${M.mainStart([v, s.kvNumHeads, 1])}
    ...
    ${O}
  }`; return { name: "ConcatPastNew", shaderCache: { hint: `${s.kvNumHeads}${v}${!!r}`, inputDependencies: b }, getRunData: () => ({ outputs: [{ dims: o, dataType: i }], dispatchGroup: f, programUniforms: x }), getShaderSource: R }
      }, vv = e => Ze({ ...e }), Cg = Ze({ perm: [0, 2, 1, 3] }), pc = (e, r, i, s, o) => { let d = r, u = s.kvNumHeads, h = s.nReps; return r.dims.length === 3 && s.kvSequenceLength !== 0 && (d = r.reshape([s.batchSize, s.kvSequenceLength, u, s.headSize])), i ? d = e.compute(fc(d, i, d.dataType, s), { inputs: [d, i], outputs: [s.isPastkvBSNH ? o : -1] })[0] : d = e.compute(fc(d, void 0, d.dataType, s), { inputs: [d], outputs: [s.isPastkvBSNH ? o : -1] })[0], h !== 1 && (d = e.compute(Fc([d], [1, 1, 1, h]), { inputs: [d], outputs: [-1] })[0], d = d.reshape([s.batchSize, s.totalSequenceLength, u * h, s.headSize])), e.compute(un(d, Cg.perm), { inputs: [d], outputs: [-1] })[0] }, _v = (e, r) => { var m; let i = Eg(e.inputs, r); if (e.inputs[0].dims.length === 5) throw new Error("Packed QKV is not implemented"); if (((m = e.inputs[1]) == null ? void 0 : m.dims.length) === 5) throw new Error("Packed KV is not implemented"); let s = Ys(e, i.batchSize, i.numHeads, i.sequenceLength, i.headSize, e.inputs[0], void 0, 0), o = e.inputs[3] && e.inputs[3].dims.length !== 0 ? e.inputs[3] : void 0, d = e.inputs[4] && e.inputs[4].dims.length !== 0 ? e.inputs[4] : void 0, u = pc(e, e.inputs[1], o, i, 1), h = pc(e, e.inputs[2], d, i, 2); Xs(e, s, u, h, void 0, void 0, void 0, void 0, void 0, i, r) }
    }), hc, Tg, Ig, $v, c2 = ne(() => {
      Ae(), Pe(), Qr(), Me(), hc = (e, r, i, s, o, d, u, h) => {
        let m = pt(d), g = m === 1 ? "f32" : `vec${m}f`, _ = m === 1 ? "vec2f" : `mat2x${m}f`, v = o * u, f = [o, u, d / m], b = [o, u, 2], x = ["rank", "type", "type"], S = []; S.push(...he(f, b)); let T = A => {
          let C = X("x", r.dataType, 3, m), O = X("scale", i.dataType, i.dims), R = X("bias", s.dataType, s.dims), M = _e("output", 1, 3, 2), W = [C, O, R, M], U = 64; return `
  ...
  }`}; return e.compute({ name: "InstanceNormComputeChannelScaleShift", shaderCache: { hint: `${m};${h}`, inputDependencies: x }, getRunData: () => ({ outputs: [{ dims: b, dataType: 1 }], dispatchGroup: { x: v }, programUniforms: S }), getShaderSource: T }, { inputs: [r, i, s], outputs: [-1] })[0]
      }, Tg = (e, r, i) => {
        let s = r[0].dims, o = s, d = 2, u = s[0], h = s[1], m = Q.sizeFromDimension(s, d), g = pt(m), _ = Q.size(o) / g, v = hc(e, r[0], r[1], r[2], u, m, h, i.epsilon), f = [u, h, m / g], b = [u, h], x = ["type", "none"], S = T => {
          let A = X("x", r[0].dataType, f.length, g), C = X("scale_shift", 1, b.length, 2), O = _e("output", r[0].dataType, f.length, g), R = [A, C, O]; return `
  ...
  }`}; e.compute({ name: "InstanceNormalization", shaderCache: { hint: `${g}`, inputDependencies: x }, getRunData: () => ({ outputs: [{ dims: o, dataType: r[0].dataType }], dispatchGroup: { x: Math.ceil(_ / 64) }, programUniforms: [{ type: 12, data: _ }, ...he(f, b, f)] }), getShaderSource: S }, { inputs: [r[0], v] })
      }, Ig = (e, r, i) => {
        let s = r[0].dims, o = s, d = s[0], u = s[s.length - 1], h = Q.sizeFromDimension(s, 1) / u, m = pt(u), g = Q.size(o) / m, _ = [{ type: 12, data: h }, { type: 12, data: Math.floor(u / m) }], v = ["type", "type"], f = [0, s.length - 1]; for (let T = 0; T < s.length - 2; T++)f.push(T + 1); let b = e.compute(un(e.inputs[0], f), { inputs: [e.inputs[0]], outputs: [-1] })[0], x = hc(e, b, r[1], r[2], d, h, u, i.epsilon), S = T => {
          let A = vt(r[0].dataType), C = m === 1 ? "vec2f" : `mat${m}x2f`, O = W => { let U = W === 0 ? "x" : "y", Y = m === 1 ? "f32" : `vec${m}f`; switch (m) { case 1: return `${A}(${Y}(scale.${U}))`; case 2: return `vec2<${A}>(${Y}(scale[0].${U}, scale[1].${U}))`; case 4: return `vec4<${A}>(${Y}(scale[0].${U}, scale[1].${U}, scale[2].${U}, scale[3].${U}))`; default: throw new Error(`Not supported compoents ${m}`) } }, R = X("input", r[0].dataType, r[0].dims, m), M = _e("output", r[0].dataType, o, m); return `
  ...
  }`}; e.compute({ name: "InstanceNormalizationNHWC", shaderCache: { hint: `${m}`, inputDependencies: v }, getRunData: () => ({ outputs: [{ dims: o, dataType: r[0].dataType }], dispatchGroup: { x: Math.ceil(g / 64) }, programUniforms: _ }), getShaderSource: S }, { inputs: [r[0], x] })
      }, $v = (e, r) => { r.format === "NHWC" ? Ig(e, e.inputs, r) : Tg(e, e.inputs, r) }
    }), zg, Ag, xv, f2 = ne(() => {
      Ae(), Pe(), Me(), zg = e => { if (!e || e.length < 2) throw new Error("layerNorm requires at least 2 inputs.") }, Ag = (e, r, i) => {
        let s = r.simplified, o = e[0].dims, d = e[1], u = !s && e[2], h = o, m = Q.normalizeAxis(r.axis, o.length), g = Q.sizeToDimension(o, m), _ = Q.sizeFromDimension(o, m), v = Q.size(d.dims), f = u ? Q.size(u.dims) : 0; if (v !== _ || u && f !== _) throw new Error(`Size of X.shape()[axis:] == ${_}.
       Size of scale and bias (if provided) must match this.
       Got scale size of ${v} and bias size of ${f}`); let b = []; for (let M = 0; M < o.length; ++M)M < m ? b.push(o[M]) : b.push(1); let x = pt(_), S = ["type", "type"], T = [{ type: 12, data: g }, { type: 1, data: _ }, { type: 12, data: Math.floor(_ / x) }, { type: 1, data: r.epsilon }]; u && S.push("type"); let A = i > 1, C = i > 2, O = M => {
          let W = vt(e[0].dataType), U = [X("x", e[0].dataType, e[0].dims, x), X("scale", d.dataType, d.dims, x)]; u && U.push(X("bias", u.dataType, u.dims, x)), U.push(_e("output", e[0].dataType, h, x)), A && U.push(_e("mean_data_output", 1, b)), C && U.push(_e("inv_std_output", 1, b)); let Y = [{ name: "norm_count", type: "u32" }, { name: "norm_size", type: "f32" }, { name: "norm_size_vectorized", type: "u32" }, { name: "epsilon", type: "f32" }]; return `
    ...
    ${C ? "inv_std_output[global_idx] = inv_std_dev" : ""};
  }`}, R = [{ dims: h, dataType: e[0].dataType }]; return A && R.push({ dims: b, dataType: 1 }), C && R.push({ dims: b, dataType: 1 }), { name: "LayerNormalization", shaderCache: { hint: `${x};${i};${s}`, inputDependencies: S }, getRunData: () => ({ outputs: R, dispatchGroup: { x: Math.ceil(g / 64) }, programUniforms: T }), getShaderSource: O }
      }, xv = (e, r) => { zg(e.inputs), e.compute(Ag(e.inputs, r, e.outputCount)) }
    }), Rg, Og, Pg, bv, Sv, p2 = ne(() => {
      Ae(), Pe(), gt(), Me(), Rg = (e, r) => { if (e.length < 3 || e.length > 4) throw new Error("MatMulNBits requires 3 or 4 inputs"); let i = e[0], s = i.dims.length; if (i.dims[s - 1] !== r.k) throw new Error("The last dim of input shape does not match the k value"); let o = Math.floor((r.k + r.blockSize - 1) / r.blockSize), d = r.blockSize / 8 * r.bits, u = e[1]; if (!Q.areEqual(u.dims, [r.n, o, d])) throw new Error("The second inputs must be 3D tensor with shape N X nBlocksPerCol X blobSize"); let h = e[2].dims; if (Q.size(h) !== r.n * o) throw new Error("scales input size error."); if (e.length === 4) { let m = e[3].dims, g = r.bits > 4 ? r.n * o : r.n * Math.floor((o + 1) / 2); if (Q.size(m) !== g) throw new Error("zeroPoints input size error.") } }, Og = (e, r) => {
        let i = e[0].dims, s = i.length, o = i[s - 2], d = r.k, u = r.n, h = i.slice(0, s - 2), m = Q.size(h), g = e[1].dims[2] / 4, _ = e[0].dataType, v = pt(r.k), f = pt(g), b = pt(u), x = h.concat([o, u]), S = o > 1 && u / b % 2 === 0 ? 2 : 1, T = Q.size(x) / b / S, A = 64, C = [], O = [m, o, d / v], R = Q.convertShape(e[1].dims).slice(); R.splice(-1, 1, g / f), C.push(...he(O)), C.push(...he(R)), C.push(...he(e[2].dims)), e.length === 4 && C.push(...he(Q.convertShape(e[3].dims))); let M = [m, o, u / b]; C.push(...he(M)); let W = U => {
          let Y = O.length, ae = X("a", e[0].dataType, Y, v), oe = X("b", 12, R.length, f), $e = X("scales", e[2].dataType, e[2].dims.length), xe = [ae, oe, $e], de = e.length === 4 ? X("zero_points", 12, e[3].dims.length) : void 0; de && xe.push(de); let Re = M.length, Be = _e("output", e[0].dataType, Re, b), be = vt(e[0].dataType), Ee = (() => { switch (v) { case 1: return `array<${be}, 8>`; case 2: return `mat4x2<${be}>`; case 4: return `mat2x4<${be}>`; default: throw new Error(`${v}-component is not supported.`) } })(), G = () => {
            let z = `
          // reuse a data
          ...
          `; return z
            ...
            let z = `col_index = col * ${b};`; for (let N = 0; N < b * S; N++)z += `
        ...
        }`}; return { name: "MatMulNBits", shaderCache: { hint: `${r.blockSize};${r.bits};${v};${f};${b};${S};${A}`, inputDependencies: Array(e.length).fill("rank") }, getRunData: () => ({ outputs: [{ dims: x, dataType: _ }], dispatchGroup: { x: T }, programUniforms: C }), getShaderSource: W }
      }, Pg = (e, r) => {
        let i = e[0].dims, s = i.length, o = i[s - 2], d = r.k, u = r.n, h = i.slice(0, s - 2), m = Q.size(h), g = e[1].dims[2] / 4, _ = e[0].dataType, v = pt(r.k), f = pt(g), b = h.concat([o, u]), x = 128, S = u % 8 === 0 ? 8 : u % 4 === 0 ? 4 : 1, T = x / S, A = T * f * 8, C = A / v, O = A / r.blockSize, R = Q.size(b) / S, M = [], W = [m, o, d / v], U = Q.convertShape(e[1].dims).slice(); U.splice(-1, 1, g / f), M.push(...he(W)), M.push(...he(U)), M.push(...he(e[2].dims)), e.length === 4 && M.push(...he(Q.convertShape(e[3].dims))); let Y = [m, o, u]; M.push(...he(Y)); let ae = oe => {
          let $e = W.length, xe = X("a", e[0].dataType, $e, v), de = X("b", 12, U.length, f), Re = X("scales", e[2].dataType, e[2].dims.length), Be = [xe, de, Re], be = e.length === 4 ? X("zero_points", 12, e[3].dims.length) : void 0; be && Be.push(be); let Ee = Y.length, G = _e("output", e[0].dataType, Ee), H = vt(e[0].dataType), Z = () => {
            switch (v) {
              case 1: return `
        ...
        }`}; return { name: "BlockwiseMatMulNBits32", shaderCache: { hint: `${r.blockSize};${v};${f};${T};${S}`, inputDependencies: Array(e.length).fill("rank") }, getRunData: () => ({ outputs: [{ dims: b, dataType: _ }], dispatchGroup: { x: R }, programUniforms: M }), getShaderSource: ae }
      }, bv = (e, r) => { Rg(e.inputs, r), r.blockSize === 32 && e.adapterInfo.isVendor("intel") && e.adapterInfo.isArchitecture("gen-12lp") ? e.compute(Pg(e.inputs, r)) : e.compute(Og(e.inputs, r)) }, Sv = e => Ze(e)
    }), Mg, Bg, Dg, Ng, Lg, Ug, jg, Fg, kv, h2 = ne(() => {
      Ae(), Pe(), Me(), Mg = e => { if (!e || e.length < 1) throw new Error("Too few inputs"); if (e[0].dataType !== 1 && e[0].dataType !== 10) throw new Error("Input type must be float or float16."); if (e.length >= 2) { let r = e[0].dims.length * 2 === e[1].dims[0]; if (e.length === 4 && (r = e[3].dims[0] * 2 === e[1].dims[0]), !r) throw new Error("The pads should be a 1D tensor of shape [2 * input_rank] or [2 * num_axes].") } }, Bg = (e, r, i) => {
        let s = ""; for (let o = r - 1; o >= 0; --o)s += `
      ...
      `}, Dg = (e, r, i) => {
        ...
        let s = ""; for (let o = r - 1; o >= 0; --o)s += `
            ...
            `; return `
              ...
              ${s}
              value = x[offset];
          `}, Ug = (e, r, i) => { switch (i.mode) { case 0: return Bg(e, r, i.pads.length); case 1: return Dg(e, r, i.pads.length); case 2: return Ng(e, r, i.pads.length); case 3: return Lg(e, r, i.pads.length); default: throw new Error("Invalid mode") } }, jg = (e, r) => {
        let i = Q.padShape(e[0].dims.slice(), r.pads), s = e[0].dims, o = Q.size(i), d = [{ type: 12, data: o }, { type: 6, data: r.pads }], u = e.length >= 3 && e[2].data; r.mode === 0 && d.push({ type: u ? e[2].dataType : 1, data: r.value }), d.push(...he(e[0].dims, i)); let h = ["rank"], m = g => {
          let _ = _e("output", e[0].dataType, i.length), v = X("x", e[0].dataType, s.length), f = v.type.value, b = Ug(_, s.length, r), x = [{ name: "output_size", type: "u32" }, { name: "pads", type: "i32", length: r.pads.length }]; return r.mode === 0 && x.push({ name: "constant_value", type: u ? f : "f32" }), `
      ...
      Bn(), Ae(), Pe(), Me(), Fs = e => { if (et.webgpu.validateInputContent && (!e || e.length !== 1)) throw new Error("Pool ops requires 1 input.") }, mc = (e, r, i) => { let s = r.format === "NHWC", o = e.dims.slice(); s && o.splice(1, 0, o.pop()); let d = Object.hasOwnProperty.call(r, "dilations"), u = r.kernelShape.slice(), h = r.strides.slice(), m = d ? r.dilations.slice() : [], g = r.pads.slice(); Zu.adjustPoolAttributes(i, o, u, h, m, g); let _ = Zu.computePoolOutputShape(i, o, h, m, u, g, r.autoPad), v = Object.assign({}, r); d ? Object.assign(v, { kernelShape: u, strides: h, pads: g, dilations: m, cacheKey: r.cacheKey }) : Object.assign(v, { kernelShape: u, strides: h, pads: g, cacheKey: r.cacheKey }); let f = _.slice(); return f.push(f.splice(1, 1)[0]), [v, s ? f : _] }, gc = (e, r) => { let i = r.format === "NHWC", s = Q.size(e), o = Q.size(r.kernelShape), d = [{ type: 12, data: s }, { type: 12, data: o }], u = [{ name: "outputSize", type: "u32" }, { name: "kernelSize", type: "u32" }]; if (r.kernelShape.length <= 2) { let h = r.kernelShape[r.kernelShape.length - 1], m = r.strides[r.strides.length - 1], g = r.pads[r.pads.length / 2 - 1], _ = r.pads[r.pads.length - 1], v = !!(g + _); d.push({ type: 12, data: h }, { type: 12, data: m }, { type: 12, data: g }, { type: 12, data: _ }), u.push({ name: "kw", type: "u32" }, { name: "sw", type: "u32" }, { name: "pwStart", type: "u32" }, { name: "pwEnd", type: "u32" }); let f = !1; if (r.kernelShape.length === 2) { let b = r.kernelShape[r.kernelShape.length - 2], x = r.strides[r.strides.length - 2], S = r.pads[r.pads.length / 2 - 2], T = r.pads[r.pads.length - 2]; f = !!(S + T), d.push({ type: 12, data: b }, { type: 12, data: x }, { type: 12, data: S }, { type: 12, data: T }), u.push({ name: "kh", type: "u32" }, { name: "sh", type: "u32" }, { name: "phStart", type: "u32" }, { name: "phEnd", type: "u32" }) } return [d, u, !0, v, f] } else { if (i) throw new Error("Pooling with kernelShape.length > 2 is not supported for NHWC format."); let h = Q.computeStrides(r.kernelShape); d.push({ type: 12, data: h }, { type: 12, data: r.pads }, { type: 12, data: r.strides }), u.push({ name: "kernelStrides", type: "u32", length: h.length }, { name: "pads", type: "u32", length: r.pads.length }, { name: "strides", type: "u32", length: r.strides.length }); let m = r.pads.reduce((g, _) => g + _); return [d, u, !!m, !1, !1] } }, yc = (e, r, i, s, o, d, u, h, m, g, _, v) => {
        let f = o.format === "NHWC", b = r.type.value, x = _e("output", r.type.tensor, s); if (o.kernelShape.length <= 2) {
          ...
          if (f) throw new Error("Pooling with kernelShape.length > 2 is not supported for NHWC format."); let S = o.kernelShape.length, T = o.pads.length, A = ""; return g ? A = `
      ...
      }, wc = e => `${e.format};${e.ceilMode};${e.autoPad};${e.kernelShape.length}`, Wg = e => `${wc(e)};${e.countIncludePad}`, Vg = e => `${wc(e)};${e.storageOrder};${e.dilations}`, vc = e => ({ format: e.format, autoPad: ["NOTSET", "VALID", "SAME_UPPER", "SAME_LOWER"][e.auto_pad], ceilMode: e.ceil_mode, kernelShape: e.kernel_shape, strides: e.strides, pads: e.pads }), _c = (e, r, i, s) => { let [o, d] = mc(r, s, i), u = X("x", r.dataType, r.dims.length), h = u.type.value, m = "value += x_val;", g = ""; o.countIncludePad ? g += `value /= ${h}(uniforms.kernelSize);` : g += `value /= ${h}(i32(uniforms.kernelSize) - pad);`; let [_, v, f, b, x] = gc(d, o); _.push(...he(r.dims, d)); let S = ["rank"]; return { name: e, shaderCache: { hint: `${s.cacheKey};${f};${b};${x}`, inputDependencies: S }, getRunData: () => ({ outputs: [{ dims: d, dataType: r.dataType }], dispatchGroup: { x: Math.ceil(Q.size(d) / 64) }, programUniforms: _ }), getShaderSource: T => yc(T, u, r.dims.length, d.length, o, m, g, 0, v, f, b, x) } }, Ev = e => { let r = e.count_include_pad !== 0, i = vc(e); if (i.ceilMode !== 0) throw new Error("using ceil() in shape computation is not yet supported for AveragePool"); let s = { countIncludePad: r, ...i, cacheKey: "" }; return { ...s, cacheKey: Wg(s) } }, Cv = (e, r) => { Fs(e.inputs), e.compute(_c("AveragePool", e.inputs[0], !1, r)) }, $c = { autoPad: "", ceilMode: 0, countIncludePad: !1, kernelShape: [], strides: [], pads: [], storageOrder: 0, dilations: [] }, Tv = e => { let r = e.format; return { format: r, ...$c, cacheKey: r } }, Iv = (e, r) => { Fs(e.inputs), e.compute(_c("GlobalAveragePool", e.inputs[0], !0, r)) }, xc = (e, r, i, s) => {
        let [o, d] = mc(r, s, i), u = `
      value = max(x_val, value);
    `, h = "", m = X("x", r.dataType, r.dims.length), g = ["rank"], [_, v, f, b, x] = gc(d, o); return _.push(...he(r.dims, d)), { name: e, shaderCache: { hint: `${s.cacheKey};${f};${b};${x}`, inputDependencies: g }, getRunData: () => ({ outputs: [{ dims: d, dataType: r.dataType }], dispatchGroup: { x: Math.ceil(Q.size(d) / 64) }, programUniforms: _ }), getShaderSource: S => yc(S, m, r.dims.length, d.length, o, u, h, r.dataType === 10 ? -65504 : -1e5, v, f, b, x) }
      }, zv = (e, r) => { Fs(e.inputs), e.compute(xc("MaxPool", e.inputs[0], !1, r)) }, Av = e => { let r = e.storage_order, i = e.dilations, s = vc(e); if (r !== 0) throw new Error("column major storage order is not yet supported for MaxPool"); if (s.ceilMode !== 0) throw new Error("using ceil() in shape computation is not yet supported for MaxPool"); let o = { storageOrder: r, dilations: i, ...s, cacheKey: "" }; return { ...o, cacheKey: Vg(o) } }, Rv = e => { let r = e.format; return { format: r, ...$c, cacheKey: r } }, Ov = (e, r) => { Fs(e.inputs), e.compute(xc("GlobalMaxPool", e.inputs[0], !0, r)) }
    }), Hg, qg, Pv, Mv, g2 = ne(() => {
      Ae(), Pe(), gt(), Me(), Hg = (e, r) => { if (e.length < 2 || e.length > 3) throw new Error("DequantizeLinear requires 2 or 3 inputs."); if (e.length === 3 && e[1].dims === e[2].dims) throw new Error("x-scale and x-zero-point must have the same shape."); if (e.length === 3 && e[0].dataType !== e[2].dataType) throw new Error("x and x-zero-point must have the same data type."); if (e[0].dataType === 6 && e.length > 2) throw new Error("In the case of dequantizing int32 there is no zero point."); if (e[1].dims.length !== 0 && e[1].dims.length !== 1 && e[1].dims.length !== e[0].dims.length) throw new Error("scale input must be a scalar, a 1D tensor, or have the same rank as the input tensor."); if (e.length > 2) { if (e[0].dataType !== e[2].dataType) throw new Error("x and x-zero-point must have the same data type."); if (e[1].dims.length !== e[2].dims.length) throw new Error("scale and zero-point inputs must have the same rank."); if (!e[1].dims.map((i, s) => i === e[2].dims[s]).reduce((i, s) => i && s, !0)) throw new Error("scale and zero-point inputs must have the same shape.") } if (r.blockSize > 0) { if (e[1].dims.length === 0 || e[1].dims.length === 1 && e[1].dims[0] === 1) throw new Error("blockSize must be set only for block quantization."); if (!e[1].dims.map((o, d) => d === r.axis || o === e[0].dims[d]).reduce((o, d) => o && d, !0)) throw new Error("For block qunatization, scale input shape to match the input shape except for the axis"); if (e[1].dims.length !== e[0].dims.length) throw new Error("For block qunatization the scale input rank must be the same as the x rank."); let i = e[0].dims[r.axis], s = e[1].dims[r.axis]; if (r.blockSize < Math.ceil(i / s) || r.blockSize > Math.ceil(i / (s - 1) - 1)) throw new Error("blockSize must be with in the range [ceil(dI / Si), ceil(dI / (Si - 1) - 1)].") } }, qg = (e, r) => {
        let i = Q.normalizeAxis(r.axis, e[0].dims.length), s = e[0].dataType, o = s === 3, d = e[0].dims, u = e[1].dataType, h = Q.size(d), m = s === 3 || s === 2, g = m ? [Math.ceil(Q.size(e[0].dims) / 4)] : e[0].dims, _ = e[1].dims, v = e.length > 2 ? e[2] : void 0, f = v ? m ? [Math.ceil(Q.size(v.dims) / 4)] : v.dims : void 0, b = _.length === 0 || _.length === 1 && _[0] === 1, x = b === !1 && _.length === 1, S = pt(h), T = b && (!m || S === 4), A = T ? S : 1, C = T && !m ? S : 1, O = X("input", m ? 12 : s, g.length, C), R = X("scale", u, _.length), M = v ? X("zero_point", m ? 12 : s, f.length) : void 0, W = _e("output", u, d.length, A), U = [O, R]; M && U.push(M); let Y = [g, _]; v && Y.push(f); let ae = [{ type: 12, data: h / A }, { type: 12, data: i }, { type: 12, data: r.blockSize }, ...he(...Y, d)], oe = $e => {
          let xe = [{ name: "output_size", type: "u32" }, { name: "axis", type: "u32" }, { name: "block_size", type: "u32" }]; return `
      ...
      }`}; return { name: "DequantizeLinear", shaderCache: { hint: r.cacheKey, inputDependencies: M ? ["rank", "rank", "rank"] : ["rank", "rank"] }, getShaderSource: oe, getRunData: () => ({ outputs: [{ dims: d, dataType: u }], dispatchGroup: { x: Math.ceil(h / A / 64), y: 1, z: 1 }, programUniforms: ae }) }
      }, Pv = (e, r) => { Hg(e.inputs, r), e.compute(qg(e.inputs, r)) }, Mv = e => Ze({ axis: e.axis, blockSize: e.blockSize })
    }), Gg, Kg, Bv, y2 = ne(() => {
      Bn(), Ae(), Me(), Gg = (e, r, i) => { let s = e === r, o = e < r && i < 0, d = e > r && i > 0; if (s || o || d) throw new Error("Range these inputs' contents are invalid.") }, Kg = (e, r, i, s) => {
        let o = Math.abs(Math.ceil((r - e) / i)), d = [o], u = o, h = [{ type: 12, data: u }, { type: s, data: e }, { type: s, data: i }, ...he(d)], m = g => {
          let _ = _e("output", s, d.length), v = _.type.value, f = [{ name: "outputSize", type: "u32" }, { name: "start", type: v }, { name: "delta", type: v }]; return `
        ${g.registerUniforms(f).declareVariables(_)}
        ${g.mainStart()}
        ${g.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.outputSize")}
        output[global_idx] = uniforms.start + ${v}(global_idx) * uniforms.delta;
      }`}; return { name: "Range", shaderCache: { hint: `${s}` }, getShaderSource: m, getRunData: () => ({ outputs: [{ dims: d, dataType: s }], dispatchGroup: { x: Math.ceil(u / 64) }, programUniforms: h }) }
      }, Bv = e => { let r = 0, i = 0, s = 0; e.inputs[0].dataType === 6 ? (r = e.inputs[0].getInt32Array()[0], i = e.inputs[1].getInt32Array()[0], s = e.inputs[2].getInt32Array()[0]) : e.inputs[0].dataType === 1 && (r = e.inputs[0].getFloat32Array()[0], i = e.inputs[1].getFloat32Array()[0], s = e.inputs[2].getFloat32Array()[0]), et.webgpu.validateInputContent && Gg(r, i, s), e.compute(Kg(r, i, s, e.inputs[0].dataType), { inputs: [] }) }
    }), Qg, Yg, Zg, Xg, Jg, ey, ty, ny, ry, iy, ay, bc, sy, oy, uy, ly, dy, Dv, Nv, w2 = ne(() => {
      Ae(), Pe(), gt(), Me(), Qg = (e, r) => {
        if (e.every(i => i > 0 || (() => { throw new Error("Resize requires scales input values to be positive") })), e.length > 0) {
          if (r.mode === "linear") {
...
`: "", sy = (e, r, i, s, o) => {
        let [d, u, h, m] = i.length === 2 ? [-1, 0, 1, -1] : [0, 2, 3, 1], g = e.type.value; return `
    ...
    }`}, oy = (e, r, i, s, o, d, u, h, m, g) => {
        let _ = i.length === 2, [v, f] = _ ? [0, 1] : [2, 3], b = e.type.value, x = S => {
          let T = S === v ? "row" : "col"; return `
  ...
  fn bicubicInterpolation(output_indices: ${r.type.indices}) -> ${b} {
    ...
    `}, uy = (e, r, i, s, o) => {
        let [d, u, h, m, g] = i.length === 3 ? [-1, 0, 1, 2, -1] : [0, 2, 3, 4, 1], _ = e.type.value; return `
...
`}
      ...
      Ae(), Pe(), gt(), Me(), cy = (e, r) => { let [i, s, o, d] = e, { numHeads: u, rotaryEmbeddingDim: h } = r; if (i.dims.length !== 3 && i.dims.length !== 4) throw new Error(`Input 'x' is expected to have 3 or 4 dimensions, got ${i.dims.length}`); if (!Q.areEqual(s.dims, []) && !Q.areEqual(s.dims, [1]) && s.dims.length !== 2) throw new Error(`Input 'position_ids' is expected to have 0, 1, or 2 dimensions, got ${s.dims.length}`); if (o.dims.length !== 2) throw new Error(`Input 'cos_cache' is expected to have 2 dimensions, got ${o.dims.length}`); if (d.dims.length !== 2) throw new Error(`Input 'sin_cache' is expected to have 2 dimensions, got ${d.dims.length}`); if (!Q.areEqual(o.dims, d.dims)) throw new Error("Inputs 'cos_cache' and 'sin_cache' are expected to have the same shape"); if (h > 0 && u === 0) throw new Error("num_heads must be provided if rotary_embedding_dim is specified"); let m = i.dims[0], g = i.dims[i.dims.length - 2], _ = o.dims[0], v = Q.sizeFromDimension(i.dims, 1) / g, f = h === 0 ? o.dims[1] * 2 : v / u; if (h > f) throw new Error("rotary_embedding_dim must be less than or equal to head_size"); if (s.dims.length === 2) { if (m !== s.dims[0]) throw new Error(`Input 'position_ids' dimension 0 should be of size batch_size, got ${s.dims[0]}`); if (g !== s.dims[1]) throw new Error(`Input 'position_ids' dimension 1 should be of size sequence_length, got ${s.dims[1]}`) } if (f / 2 !== o.dims[1] && h / 2 !== o.dims[1]) throw new Error(`Input 'cos_cache' dimension 1 should be same as head_size / 2 or rotary_embedding_dim / 2, got ${o.dims[1]}`); if (g > _) throw new Error("Updating cos_cache and sin_cache in RotaryEmbedding is not currently supported") }, fy = (e, r) => {
        ...
        }`}; return { name: "RotaryEmbedding", shaderCache: { hint: Ze({ interleaved: i }).cacheKey, inputDependencies: ["rank", "rank", "rank", "rank"] }, getShaderSource: S, getRunData: () => ({ outputs: [{ dims: e[0].dims, dataType: e[0].dataType }], dispatchGroup: { x: Math.ceil(Q.size(f) / Ra) }, programUniforms: x }) }
      }, Lv = (e, r) => { cy(e.inputs, r), e.compute(fy(e.inputs, r)) }
    }), py, hy, Uv, _2 = ne(() => {
      Ae(), Pe(), Me(), py = e => { if (!e || e.length < 3) throw new Error("layerNorm requires at least 3 inputs."); let r = e[0], i = e[1], s = e[2]; if (r.dataType !== i.dataType || r.dataType !== s.dataType) throw new Error("All inputs must have the same data type"); if (r.dims.length !== 3 && r.dims.length !== 2) throw new Error("Input must be 2D or 3D"); if (i.dims.length !== 3 && i.dims.length !== 2) throw new Error("Skip must be 2D or 3D"); let o = r.dims[r.dims.length - 1], d = r.dims[r.dims.length - 2]; if (i.dims[i.dims.length - 1] !== o) throw new Error("Skip must have the same hidden size as input"); if (i.dims[i.dims.length - 2] !== d) throw new Error("Skip must have the same sequence length as input"); if (s.dims.length !== 1) throw new Error("Gamma must be 1D"); if (s.dims[s.dims.length - 1] !== o) throw new Error("Gamma must have the same hidden size as input"); if (e.length > 3) { let u = e[3]; if (u.dims.length !== 1) throw new Error("Beta must be 1D"); if (u.dims[u.dims.length - 1] !== o) throw new Error("Beta must have the same hidden size as input") } if (e.length > 4) { let u = e[4]; if (u.dims.length !== 1) throw new Error("Bias must be 1D"); if (u.dims[u.dims.length - 1] !== o) throw new Error("Bias must have the same hidden size as input") } }, hy = (e, r, i, s) => {
        let o = r.simplified, d = e[0].dims, u = Q.size(d), h = d, m = u, g = d.slice(-1)[0], _ = s ? d.slice(0, -1).concat(1) : [], v = !o && e.length > 3, f = e.length > 4, b = s && i > 1, x = s && i > 2, S = i > 3, T = 64, A = pt(g), C = [{ type: 12, data: m }, { type: 12, data: A }, { type: 12, data: g }, { type: 1, data: r.epsilon }], O = M => {
          let W = [{ name: "output_size", type: "u32" }, { name: "components", type: "u32" }, { name: "hidden_size", type: "u32" }, { name: "epsilon", type: "f32" }], U = [X("x", e[0].dataType, e[0].dims, A), X("skip", e[1].dataType, e[1].dims, A), X("gamma", e[2].dataType, e[2].dims, A)]; v && U.push(X("beta", e[3].dataType, e[3].dims, A)), f && U.push(X("bias", e[4].dataType, e[4].dims, A)), U.push(_e("output", e[0].dataType, h, A)), b && U.push(_e("mean_output", 1, _)), x && U.push(_e("inv_std_output", 1, _)), S && U.push(_e("input_skip_bias_sum", e[0].dataType, h, A)); let Y = vt(e[0].dataType), ae = vt(1, A); return `
      ...
      }`; return { name: "Slice", shaderCache: { hint: `${m.length}_${u.length}_${d.length}`, inputDependencies: ["rank"] }, getShaderSource: T, getRunData: () => ({ outputs: [_], dispatchGroup: { x: Math.ceil(s / 64) }, programUniforms: S }) }
      }, jv = (e, r) => { my(e.inputs, r); let i = gy(e.inputs, r); e.compute(wy(e.inputs, i), { inputs: [0] }) }, Fv = e => { let r = e.starts, i = e.ends, s = e.axes; return Ze({ starts: r, ends: i, axes: s }) }
    }), vy, _y, Wv, Vv, x2 = ne(() => {
      Ae(), Pe(), gt(), Qr(), Me(), vy = e => { if (!e || e.length !== 1) throw new Error("Softmax op requires 1 input.") }, _y = (e, r) => {
        let i = e.inputs[0], s = i.dims, o = Q.size(s), d = 64, u = s.length, h = Q.normalizeAxis(r.axis, u), m = h < s.length - 1, g, _ = []; m ? (_ = Array.from({ length: u }, (U, Y) => Y), _[h] = u - 1, _[u - 1] = h, g = e.compute(un(i, _), { inputs: [i], outputs: [-1] })[0]) : g = i; let v = g.dims, f = v[u - 1], b = o / f, x = pt(f), S = f / x, T = (U, Y) => Y === 4 ? `max(max(${U}.x, ${U}.y), max(${U}.z, ${U}.w))` : Y === 2 ? `max(${U}.x, ${U}.y)` : Y === 3 ? `max(max(${U}.x, ${U}.y), ${U}.z)` : U, A = X("x", g.dataType, g.dims, x), C = _e("result", g.dataType, g.dims, x), O = A.type.value, R = vt(g.dataType) === "f32" ? `var threadMax = ${O}(-3.402823e+38f);` : `var threadMax = ${O}(-65504.0h);`, M = U => `
      ...
      }`, W = e.compute({ name: "Softmax", shaderCache: { hint: `${x}`, inputDependencies: ["type"] }, getRunData: () => ({ outputs: [{ dims: v, dataType: g.dataType }], dispatchGroup: { x: b }, programUniforms: [{ type: 6, data: S }] }), getShaderSource: M }, { inputs: [g], outputs: [m ? -1 : 0] })[0]; m && e.compute(un(W, _), { inputs: [W] })
      }, Wv = (e, r) => { vy(e.inputs), _y(e, r) }, Vv = e => Ze({ axis: e.axis })
    }), $y, xy, by, Sy, ky, Hv, qv, b2 = ne(() => {
      Ae(), Pe(), gt(), Me(), $y = e => { if (!e || e.length < 1) throw new Error("too few inputs") }, xy = (e, r) => { let i = [], s = r.numOutputs; return e[1].dims[0] > 0 && (e[1].getBigInt64Array().forEach(o => i.push(Number(o))), s = i.length), Ze({ numOutputs: s, axis: r.axis, splitSizes: i }) }, by = e => `
...
`)}
  ...
  }`; return { name: "Split", shaderCache: { hint: r.cacheKey, inputDependencies: ["rank"] }, getShaderSource: b, getRunData: () => ({ outputs: g, dispatchGroup: { x: Math.ceil(s / 64) }, programUniforms: f }) }
      }, Hv = (e, r) => { $y(e.inputs); let i = e.inputs.length === 1 ? r : xy(e.inputs, r); e.compute(ky(e.inputs, i), { inputs: [0] }) }, qv = e => { let r = e.axis, i = e.splitSizes, s = e.numOutputs < 0 ? i.length : e.numOutputs; if (s !== i.length) throw new Error("numOutputs and splitSizes lengh must be equal"); return Ze({ axis: r, numOutputs: s, splitSizes: i }) }
    }), Ey, Cy, Gv, S2 = ne(() => {
      Ae(), Pe(), Me(), Ey = (e, r, i, s, o) => {
        let d = _e("output_data", o, i.length, 4), u = X("a_data", r[1].dataType, r[1].dims.length, 4), h = X("b_data", r[2].dataType, r[2].dims.length, 4), m = X("c_data", r[0].dataType, r[0].dims.length, 4), g, _ = (v, f, b) => `select(${f}, ${v}, ${b})`; if (!s) g = d.setByOffset("global_idx", _(u.getByOffset("global_idx"), h.getByOffset("global_idx"), m.getByOffset("global_idx"))); else {
          let v = (f, b, x = "") => {
            let S = `a_data[index_a${b}][component_a${b}]`, T = `b_data[index_b${b}][component_b${b}]`, A = `bool(c_data[index_c${b}] & (0xffu << (component_c${b} * 8)))`; return `
